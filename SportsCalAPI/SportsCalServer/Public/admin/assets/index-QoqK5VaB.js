var pe=Object.defineProperty;var ve=(r,e,t)=>e in r?pe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var m=(r,e,t)=>ve(r,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();class ye{constructor(e=""){m(this,"baseUrl");this.baseUrl=e}async fetch(e,t){const s=await fetch(`${this.baseUrl}${e}`,{...t,headers:{"Content-Type":"application/json",...t==null?void 0:t.headers}});if(!s.ok)throw new Error(`API error: ${s.statusText}`);return s.json()}async getHealth(){return this.fetch("/api/admin/health")}async getMetrics(){return this.fetch("/api/admin/metrics")}async getRedisKeys(){return this.fetch("/api/admin/redis/keys")}async getRedisKey(e){return this.fetch(`/api/admin/redis/key/${encodeURIComponent(e)}`)}async getDataGaps(){return this.fetch("/api/admin/data-gaps")}async getLeagueStats(e){return this.fetch(`/api/admin/leagues/${e}/stats`)}async getSchedules(){return this.fetch("/v2025/schedules")}async getTeams(){return this.fetch("/v2025/teams")}async getLiveGames(){return this.fetch("/v2025/all-live-games")}async invalidateKey(e){return this.fetch(`/api/admin/redis/invalidate/${encodeURIComponent(e)}`,{method:"POST"})}async refreshSchedules(){return this.fetch("/api/admin/redis/refresh",{method:"POST"})}async forceRefresh(){return this.fetch("/api/admin/force-refresh",{method:"POST"})}async triggerJob(e){return this.fetch(`/api/admin/jobs/trigger/${e}`,{method:"POST"})}async clearAllCache(){return this.fetch("/api/admin/cache/all",{method:"DELETE"})}async getPushToStartRegistrations(){return this.fetch("/api/admin/push-to-start/registrations")}async getPushToStartDiagnostics(){return this.fetch("/api/admin/push-to-start/diagnostics")}async triggerDebugPushToStart(e,t,s){return this.fetch("/v2025/debug/trigger-push-to-start",{method:"POST",body:JSON.stringify({eventID:e,homeTeam:t,awayTeam:s})})}}const C=new ye;class be{constructor(e="ws://localhost:8080/ws"){m(this,"ws",null);m(this,"reconnectTimer",null);m(this,"reconnectDelay",5e3);m(this,"url");m(this,"onMessageCallback",null);m(this,"onStatusChange",null);this.url=e}connect(e,t){var s;this.onMessageCallback=e,this.onStatusChange=t||null;try{const n=window.location.protocol==="https:"?this.url.replace("ws://","wss://"):this.url;this.ws=new WebSocket(n),this.ws.onopen=()=>{var a;console.log("WebSocket connected"),(a=this.onStatusChange)==null||a.call(this,!0),this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null)},this.ws.onmessage=a=>{var i;try{const o=JSON.parse(a.data);(i=this.onMessageCallback)==null||i.call(this,o)}catch(o){console.error("Failed to parse WebSocket message:",o)}},this.ws.onerror=a=>{var i;console.error("WebSocket error:",a),(i=this.onStatusChange)==null||i.call(this,!1)},this.ws.onclose=()=>{var a;console.log("WebSocket disconnected"),(a=this.onStatusChange)==null||a.call(this,!1),this.scheduleReconnect()}}catch(n){console.error("Failed to connect WebSocket:",n),(s=this.onStatusChange)==null||s.call(this,!1),this.scheduleReconnect()}}scheduleReconnect(){this.reconnectTimer||(this.reconnectTimer=setTimeout(()=>{console.log("Attempting to reconnect WebSocket..."),this.onMessageCallback&&this.connect(this.onMessageCallback,this.onStatusChange||void 0)},this.reconnectDelay))}disconnect(){this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws&&(this.ws.close(),this.ws=null)}isConnected(){var e;return((e=this.ws)==null?void 0:e.readyState)===WebSocket.OPEN}}function $(r){const e=Object.prototype.toString.call(r);return r instanceof Date||typeof r=="object"&&e==="[object Date]"?new r.constructor(+r):typeof r=="number"||e==="[object Number]"||typeof r=="string"||e==="[object String]"?new Date(r):new Date(NaN)}function A(r,e){return r instanceof Date?new r.constructor(e):new Date(e)}const de=6048e5,we=864e5,B=43200,ee=1440;let xe={};function N(){return xe}function G(r,e){var o,l,c,d;const t=N(),s=(e==null?void 0:e.weekStartsOn)??((l=(o=e==null?void 0:e.locale)==null?void 0:o.options)==null?void 0:l.weekStartsOn)??t.weekStartsOn??((d=(c=t.locale)==null?void 0:c.options)==null?void 0:d.weekStartsOn)??0,n=$(r),a=n.getDay(),i=(a<s?7:0)+a-s;return n.setDate(n.getDate()-i),n.setHours(0,0,0,0),n}function Y(r){return G(r,{weekStartsOn:1})}function ue(r){const e=$(r),t=e.getFullYear(),s=A(r,0);s.setFullYear(t+1,0,4),s.setHours(0,0,0,0);const n=Y(s),a=A(r,0);a.setFullYear(t,0,4),a.setHours(0,0,0,0);const i=Y(a);return e.getTime()>=n.getTime()?t+1:e.getTime()>=i.getTime()?t:t-1}function te(r){const e=$(r);return e.setHours(0,0,0,0),e}function U(r){const e=$(r),t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()));return t.setUTCFullYear(e.getFullYear()),+r-+t}function $e(r,e){const t=te(r),s=te(e),n=+t-U(t),a=+s-U(s);return Math.round((n-a)/we)}function Se(r){const e=ue(r),t=A(r,0);return t.setFullYear(e,0,4),t.setHours(0,0,0,0),Y(t)}function _(r,e){const t=$(r),s=$(e),n=t.getTime()-s.getTime();return n<0?-1:n>0?1:n}function Te(r){return A(r,Date.now())}function Le(r){return r instanceof Date||typeof r=="object"&&Object.prototype.toString.call(r)==="[object Date]"}function ke(r){if(!Le(r)&&typeof r!="number")return!1;const e=$(r);return!isNaN(Number(e))}function Ee(r,e){const t=$(r),s=$(e),n=t.getFullYear()-s.getFullYear(),a=t.getMonth()-s.getMonth();return n*12+a}function Ce(r){return e=>{const s=(r?Math[r]:Math.trunc)(e);return s===0?0:s}}function Me(r,e){return+$(r)-+$(e)}function Pe(r){const e=$(r);return e.setHours(23,59,59,999),e}function De(r){const e=$(r),t=e.getMonth();return e.setFullYear(e.getFullYear(),t+1,0),e.setHours(23,59,59,999),e}function Ae(r){const e=$(r);return+Pe(e)==+De(e)}function Fe(r,e){const t=$(r),s=$(e),n=_(t,s),a=Math.abs(Ee(t,s));let i;if(a<1)i=0;else{t.getMonth()===1&&t.getDate()>27&&t.setDate(30),t.setMonth(t.getMonth()-n*a);let o=_(t,s)===-n;Ae($(r))&&a===1&&_(r,s)===1&&(o=!1),i=n*(a-Number(o))}return i===0?0:i}function He(r,e,t){const s=Me(r,e)/1e3;return Ce(t==null?void 0:t.roundingMethod)(s)}function Re(r){const e=$(r),t=A(r,0);return t.setFullYear(e.getFullYear(),0,1),t.setHours(0,0,0,0),t}const ze={lessThanXSeconds:{one:"less than a second",other:"less than {{count}} seconds"},xSeconds:{one:"1 second",other:"{{count}} seconds"},halfAMinute:"half a minute",lessThanXMinutes:{one:"less than a minute",other:"less than {{count}} minutes"},xMinutes:{one:"1 minute",other:"{{count}} minutes"},aboutXHours:{one:"about 1 hour",other:"about {{count}} hours"},xHours:{one:"1 hour",other:"{{count}} hours"},xDays:{one:"1 day",other:"{{count}} days"},aboutXWeeks:{one:"about 1 week",other:"about {{count}} weeks"},xWeeks:{one:"1 week",other:"{{count}} weeks"},aboutXMonths:{one:"about 1 month",other:"about {{count}} months"},xMonths:{one:"1 month",other:"{{count}} months"},aboutXYears:{one:"about 1 year",other:"about {{count}} years"},xYears:{one:"1 year",other:"{{count}} years"},overXYears:{one:"over 1 year",other:"over {{count}} years"},almostXYears:{one:"almost 1 year",other:"almost {{count}} years"}},Oe=(r,e,t)=>{let s;const n=ze[r];return typeof n=="string"?s=n:e===1?s=n.one:s=n.other.replace("{{count}}",e.toString()),t!=null&&t.addSuffix?t.comparison&&t.comparison>0?"in "+s:s+" ago":s};function X(r){return(e={})=>{const t=e.width?String(e.width):r.defaultWidth;return r.formats[t]||r.formats[r.defaultWidth]}}const We={full:"EEEE, MMMM do, y",long:"MMMM do, y",medium:"MMM d, y",short:"MM/dd/yyyy"},Ge={full:"h:mm:ss a zzzz",long:"h:mm:ss a z",medium:"h:mm:ss a",short:"h:mm a"},Ne={full:"{{date}} 'at' {{time}}",long:"{{date}} 'at' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},Be={date:X({formats:We,defaultWidth:"full"}),time:X({formats:Ge,defaultWidth:"full"}),dateTime:X({formats:Ne,defaultWidth:"full"})},qe={lastWeek:"'last' eeee 'at' p",yesterday:"'yesterday at' p",today:"'today at' p",tomorrow:"'tomorrow at' p",nextWeek:"eeee 'at' p",other:"P"},Ie=(r,e,t,s)=>qe[r];function O(r){return(e,t)=>{const s=t!=null&&t.context?String(t.context):"standalone";let n;if(s==="formatting"&&r.formattingValues){const i=r.defaultFormattingWidth||r.defaultWidth,o=t!=null&&t.width?String(t.width):i;n=r.formattingValues[o]||r.formattingValues[i]}else{const i=r.defaultWidth,o=t!=null&&t.width?String(t.width):r.defaultWidth;n=r.values[o]||r.values[i]}const a=r.argumentCallback?r.argumentCallback(e):e;return n[a]}}const je={narrow:["B","A"],abbreviated:["BC","AD"],wide:["Before Christ","Anno Domini"]},_e={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1st quarter","2nd quarter","3rd quarter","4th quarter"]},Ye={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],wide:["January","February","March","April","May","June","July","August","September","October","November","December"]},Ue={narrow:["S","M","T","W","T","F","S"],short:["Su","Mo","Tu","We","Th","Fr","Sa"],abbreviated:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],wide:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Ke={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"}},Xe={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"}},Ve=(r,e)=>{const t=Number(r),s=t%100;if(s>20||s<10)switch(s%10){case 1:return t+"st";case 2:return t+"nd";case 3:return t+"rd"}return t+"th"},Je={ordinalNumber:Ve,era:O({values:je,defaultWidth:"wide"}),quarter:O({values:_e,defaultWidth:"wide",argumentCallback:r=>r-1}),month:O({values:Ye,defaultWidth:"wide"}),day:O({values:Ue,defaultWidth:"wide"}),dayPeriod:O({values:Ke,defaultWidth:"wide",formattingValues:Xe,defaultFormattingWidth:"wide"})};function W(r){return(e,t={})=>{const s=t.width,n=s&&r.matchPatterns[s]||r.matchPatterns[r.defaultMatchWidth],a=e.match(n);if(!a)return null;const i=a[0],o=s&&r.parsePatterns[s]||r.parsePatterns[r.defaultParseWidth],l=Array.isArray(o)?Ze(o,h=>h.test(i)):Qe(o,h=>h.test(i));let c;c=r.valueCallback?r.valueCallback(l):l,c=t.valueCallback?t.valueCallback(c):c;const d=e.slice(i.length);return{value:c,rest:d}}}function Qe(r,e){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t)&&e(r[t]))return t}function Ze(r,e){for(let t=0;t<r.length;t++)if(e(r[t]))return t}function et(r){return(e,t={})=>{const s=e.match(r.matchPattern);if(!s)return null;const n=s[0],a=e.match(r.parsePattern);if(!a)return null;let i=r.valueCallback?r.valueCallback(a[0]):a[0];i=t.valueCallback?t.valueCallback(i):i;const o=e.slice(n.length);return{value:i,rest:o}}}const tt=/^(\d+)(th|st|nd|rd)?/i,st=/\d+/i,rt={narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},nt={any:[/^b/i,/^(a|c)/i]},at={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},it={any:[/1/i,/2/i,/3/i,/4/i]},ot={narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},lt={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ct={narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},dt={narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},ut={narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},ht={any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},mt={ordinalNumber:et({matchPattern:tt,parsePattern:st,valueCallback:r=>parseInt(r,10)}),era:W({matchPatterns:rt,defaultMatchWidth:"wide",parsePatterns:nt,defaultParseWidth:"any"}),quarter:W({matchPatterns:at,defaultMatchWidth:"wide",parsePatterns:it,defaultParseWidth:"any",valueCallback:r=>r+1}),month:W({matchPatterns:ot,defaultMatchWidth:"wide",parsePatterns:lt,defaultParseWidth:"any"}),day:W({matchPatterns:ct,defaultMatchWidth:"wide",parsePatterns:dt,defaultParseWidth:"any"}),dayPeriod:W({matchPatterns:ut,defaultMatchWidth:"any",parsePatterns:ht,defaultParseWidth:"any"})},he={code:"en-US",formatDistance:Oe,formatLong:Be,formatRelative:Ie,localize:Je,match:mt,options:{weekStartsOn:0,firstWeekContainsDate:1}};function gt(r){const e=$(r);return $e(e,Re(e))+1}function ft(r){const e=$(r),t=+Y(e)-+Se(e);return Math.round(t/de)+1}function me(r,e){var d,h,u,f;const t=$(r),s=t.getFullYear(),n=N(),a=(e==null?void 0:e.firstWeekContainsDate)??((h=(d=e==null?void 0:e.locale)==null?void 0:d.options)==null?void 0:h.firstWeekContainsDate)??n.firstWeekContainsDate??((f=(u=n.locale)==null?void 0:u.options)==null?void 0:f.firstWeekContainsDate)??1,i=A(r,0);i.setFullYear(s+1,0,a),i.setHours(0,0,0,0);const o=G(i,e),l=A(r,0);l.setFullYear(s,0,a),l.setHours(0,0,0,0);const c=G(l,e);return t.getTime()>=o.getTime()?s+1:t.getTime()>=c.getTime()?s:s-1}function pt(r,e){var o,l,c,d;const t=N(),s=(e==null?void 0:e.firstWeekContainsDate)??((l=(o=e==null?void 0:e.locale)==null?void 0:o.options)==null?void 0:l.firstWeekContainsDate)??t.firstWeekContainsDate??((d=(c=t.locale)==null?void 0:c.options)==null?void 0:d.firstWeekContainsDate)??1,n=me(r,e),a=A(r,0);return a.setFullYear(n,0,s),a.setHours(0,0,0,0),G(a,e)}function vt(r,e){const t=$(r),s=+G(t,e)-+pt(t,e);return Math.round(s/de)+1}function x(r,e){const t=r<0?"-":"",s=Math.abs(r).toString().padStart(e,"0");return t+s}const D={y(r,e){const t=r.getFullYear(),s=t>0?t:1-t;return x(e==="yy"?s%100:s,e.length)},M(r,e){const t=r.getMonth();return e==="M"?String(t+1):x(t+1,2)},d(r,e){return x(r.getDate(),e.length)},a(r,e){const t=r.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return t.toUpperCase();case"aaa":return t;case"aaaaa":return t[0];case"aaaa":default:return t==="am"?"a.m.":"p.m."}},h(r,e){return x(r.getHours()%12||12,e.length)},H(r,e){return x(r.getHours(),e.length)},m(r,e){return x(r.getMinutes(),e.length)},s(r,e){return x(r.getSeconds(),e.length)},S(r,e){const t=e.length,s=r.getMilliseconds(),n=Math.trunc(s*Math.pow(10,t-3));return x(n,e.length)}},R={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},se={G:function(r,e,t){const s=r.getFullYear()>0?1:0;switch(e){case"G":case"GG":case"GGG":return t.era(s,{width:"abbreviated"});case"GGGGG":return t.era(s,{width:"narrow"});case"GGGG":default:return t.era(s,{width:"wide"})}},y:function(r,e,t){if(e==="yo"){const s=r.getFullYear(),n=s>0?s:1-s;return t.ordinalNumber(n,{unit:"year"})}return D.y(r,e)},Y:function(r,e,t,s){const n=me(r,s),a=n>0?n:1-n;if(e==="YY"){const i=a%100;return x(i,2)}return e==="Yo"?t.ordinalNumber(a,{unit:"year"}):x(a,e.length)},R:function(r,e){const t=ue(r);return x(t,e.length)},u:function(r,e){const t=r.getFullYear();return x(t,e.length)},Q:function(r,e,t){const s=Math.ceil((r.getMonth()+1)/3);switch(e){case"Q":return String(s);case"QQ":return x(s,2);case"Qo":return t.ordinalNumber(s,{unit:"quarter"});case"QQQ":return t.quarter(s,{width:"abbreviated",context:"formatting"});case"QQQQQ":return t.quarter(s,{width:"narrow",context:"formatting"});case"QQQQ":default:return t.quarter(s,{width:"wide",context:"formatting"})}},q:function(r,e,t){const s=Math.ceil((r.getMonth()+1)/3);switch(e){case"q":return String(s);case"qq":return x(s,2);case"qo":return t.ordinalNumber(s,{unit:"quarter"});case"qqq":return t.quarter(s,{width:"abbreviated",context:"standalone"});case"qqqqq":return t.quarter(s,{width:"narrow",context:"standalone"});case"qqqq":default:return t.quarter(s,{width:"wide",context:"standalone"})}},M:function(r,e,t){const s=r.getMonth();switch(e){case"M":case"MM":return D.M(r,e);case"Mo":return t.ordinalNumber(s+1,{unit:"month"});case"MMM":return t.month(s,{width:"abbreviated",context:"formatting"});case"MMMMM":return t.month(s,{width:"narrow",context:"formatting"});case"MMMM":default:return t.month(s,{width:"wide",context:"formatting"})}},L:function(r,e,t){const s=r.getMonth();switch(e){case"L":return String(s+1);case"LL":return x(s+1,2);case"Lo":return t.ordinalNumber(s+1,{unit:"month"});case"LLL":return t.month(s,{width:"abbreviated",context:"standalone"});case"LLLLL":return t.month(s,{width:"narrow",context:"standalone"});case"LLLL":default:return t.month(s,{width:"wide",context:"standalone"})}},w:function(r,e,t,s){const n=vt(r,s);return e==="wo"?t.ordinalNumber(n,{unit:"week"}):x(n,e.length)},I:function(r,e,t){const s=ft(r);return e==="Io"?t.ordinalNumber(s,{unit:"week"}):x(s,e.length)},d:function(r,e,t){return e==="do"?t.ordinalNumber(r.getDate(),{unit:"date"}):D.d(r,e)},D:function(r,e,t){const s=gt(r);return e==="Do"?t.ordinalNumber(s,{unit:"dayOfYear"}):x(s,e.length)},E:function(r,e,t){const s=r.getDay();switch(e){case"E":case"EE":case"EEE":return t.day(s,{width:"abbreviated",context:"formatting"});case"EEEEE":return t.day(s,{width:"narrow",context:"formatting"});case"EEEEEE":return t.day(s,{width:"short",context:"formatting"});case"EEEE":default:return t.day(s,{width:"wide",context:"formatting"})}},e:function(r,e,t,s){const n=r.getDay(),a=(n-s.weekStartsOn+8)%7||7;switch(e){case"e":return String(a);case"ee":return x(a,2);case"eo":return t.ordinalNumber(a,{unit:"day"});case"eee":return t.day(n,{width:"abbreviated",context:"formatting"});case"eeeee":return t.day(n,{width:"narrow",context:"formatting"});case"eeeeee":return t.day(n,{width:"short",context:"formatting"});case"eeee":default:return t.day(n,{width:"wide",context:"formatting"})}},c:function(r,e,t,s){const n=r.getDay(),a=(n-s.weekStartsOn+8)%7||7;switch(e){case"c":return String(a);case"cc":return x(a,e.length);case"co":return t.ordinalNumber(a,{unit:"day"});case"ccc":return t.day(n,{width:"abbreviated",context:"standalone"});case"ccccc":return t.day(n,{width:"narrow",context:"standalone"});case"cccccc":return t.day(n,{width:"short",context:"standalone"});case"cccc":default:return t.day(n,{width:"wide",context:"standalone"})}},i:function(r,e,t){const s=r.getDay(),n=s===0?7:s;switch(e){case"i":return String(n);case"ii":return x(n,e.length);case"io":return t.ordinalNumber(n,{unit:"day"});case"iii":return t.day(s,{width:"abbreviated",context:"formatting"});case"iiiii":return t.day(s,{width:"narrow",context:"formatting"});case"iiiiii":return t.day(s,{width:"short",context:"formatting"});case"iiii":default:return t.day(s,{width:"wide",context:"formatting"})}},a:function(r,e,t){const n=r.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"aaa":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"aaaaa":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"aaaa":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},b:function(r,e,t){const s=r.getHours();let n;switch(s===12?n=R.noon:s===0?n=R.midnight:n=s/12>=1?"pm":"am",e){case"b":case"bb":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"bbb":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"bbbbb":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"bbbb":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},B:function(r,e,t){const s=r.getHours();let n;switch(s>=17?n=R.evening:s>=12?n=R.afternoon:s>=4?n=R.morning:n=R.night,e){case"B":case"BB":case"BBB":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"BBBBB":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"BBBB":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},h:function(r,e,t){if(e==="ho"){let s=r.getHours()%12;return s===0&&(s=12),t.ordinalNumber(s,{unit:"hour"})}return D.h(r,e)},H:function(r,e,t){return e==="Ho"?t.ordinalNumber(r.getHours(),{unit:"hour"}):D.H(r,e)},K:function(r,e,t){const s=r.getHours()%12;return e==="Ko"?t.ordinalNumber(s,{unit:"hour"}):x(s,e.length)},k:function(r,e,t){let s=r.getHours();return s===0&&(s=24),e==="ko"?t.ordinalNumber(s,{unit:"hour"}):x(s,e.length)},m:function(r,e,t){return e==="mo"?t.ordinalNumber(r.getMinutes(),{unit:"minute"}):D.m(r,e)},s:function(r,e,t){return e==="so"?t.ordinalNumber(r.getSeconds(),{unit:"second"}):D.s(r,e)},S:function(r,e){return D.S(r,e)},X:function(r,e,t){const s=r.getTimezoneOffset();if(s===0)return"Z";switch(e){case"X":return ne(s);case"XXXX":case"XX":return F(s);case"XXXXX":case"XXX":default:return F(s,":")}},x:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"x":return ne(s);case"xxxx":case"xx":return F(s);case"xxxxx":case"xxx":default:return F(s,":")}},O:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"O":case"OO":case"OOO":return"GMT"+re(s,":");case"OOOO":default:return"GMT"+F(s,":")}},z:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"z":case"zz":case"zzz":return"GMT"+re(s,":");case"zzzz":default:return"GMT"+F(s,":")}},t:function(r,e,t){const s=Math.trunc(r.getTime()/1e3);return x(s,e.length)},T:function(r,e,t){const s=r.getTime();return x(s,e.length)}};function re(r,e=""){const t=r>0?"-":"+",s=Math.abs(r),n=Math.trunc(s/60),a=s%60;return a===0?t+String(n):t+String(n)+e+x(a,2)}function ne(r,e){return r%60===0?(r>0?"-":"+")+x(Math.abs(r)/60,2):F(r,e)}function F(r,e=""){const t=r>0?"-":"+",s=Math.abs(r),n=x(Math.trunc(s/60),2),a=x(s%60,2);return t+n+e+a}const ae=(r,e)=>{switch(r){case"P":return e.date({width:"short"});case"PP":return e.date({width:"medium"});case"PPP":return e.date({width:"long"});case"PPPP":default:return e.date({width:"full"})}},ge=(r,e)=>{switch(r){case"p":return e.time({width:"short"});case"pp":return e.time({width:"medium"});case"ppp":return e.time({width:"long"});case"pppp":default:return e.time({width:"full"})}},yt=(r,e)=>{const t=r.match(/(P+)(p+)?/)||[],s=t[1],n=t[2];if(!n)return ae(r,e);let a;switch(s){case"P":a=e.dateTime({width:"short"});break;case"PP":a=e.dateTime({width:"medium"});break;case"PPP":a=e.dateTime({width:"long"});break;case"PPPP":default:a=e.dateTime({width:"full"});break}return a.replace("{{date}}",ae(s,e)).replace("{{time}}",ge(n,e))},bt={p:ge,P:yt},wt=/^D+$/,xt=/^Y+$/,$t=["D","DD","YY","YYYY"];function St(r){return wt.test(r)}function Tt(r){return xt.test(r)}function Lt(r,e,t){const s=kt(r,e,t);if(console.warn(s),$t.includes(r))throw new RangeError(s)}function kt(r,e,t){const s=r[0]==="Y"?"years":"days of the month";return`Use \`${r.toLowerCase()}\` instead of \`${r}\` (in \`${e}\`) for formatting ${s} to the input \`${t}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}const Et=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,Ct=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,Mt=/^'([^]*?)'?$/,Pt=/''/g,Dt=/[a-zA-Z]/;function At(r,e,t){var d,h,u,f;const s=N(),n=s.locale??he,a=s.firstWeekContainsDate??((h=(d=s.locale)==null?void 0:d.options)==null?void 0:h.firstWeekContainsDate)??1,i=s.weekStartsOn??((f=(u=s.locale)==null?void 0:u.options)==null?void 0:f.weekStartsOn)??0,o=$(r);if(!ke(o))throw new RangeError("Invalid time value");let l=e.match(Ct).map(g=>{const p=g[0];if(p==="p"||p==="P"){const T=bt[p];return T(g,n.formatLong)}return g}).join("").match(Et).map(g=>{if(g==="''")return{isToken:!1,value:"'"};const p=g[0];if(p==="'")return{isToken:!1,value:Ft(g)};if(se[p])return{isToken:!0,value:g};if(p.match(Dt))throw new RangeError("Format string contains an unescaped latin alphabet character `"+p+"`");return{isToken:!1,value:g}});n.localize.preprocessor&&(l=n.localize.preprocessor(o,l));const c={firstWeekContainsDate:a,weekStartsOn:i,locale:n};return l.map(g=>{if(!g.isToken)return g.value;const p=g.value;(Tt(p)||St(p))&&Lt(p,e,String(r));const T=se[p[0]];return T(o,p,n.localize,c)}).join("")}function Ft(r){const e=r.match(Mt);return e?e[1].replace(Pt,"'"):r}function Ht(r,e,t){const s=N(),n=(t==null?void 0:t.locale)??s.locale??he,a=2520,i=_(r,e);if(isNaN(i))throw new RangeError("Invalid time value");const o=Object.assign({},t,{addSuffix:t==null?void 0:t.addSuffix,comparison:i});let l,c;i>0?(l=$(e),c=$(r)):(l=$(r),c=$(e));const d=He(c,l),h=(U(c)-U(l))/1e3,u=Math.round((d-h)/60);let f;if(u<2)return t!=null&&t.includeSeconds?d<5?n.formatDistance("lessThanXSeconds",5,o):d<10?n.formatDistance("lessThanXSeconds",10,o):d<20?n.formatDistance("lessThanXSeconds",20,o):d<40?n.formatDistance("halfAMinute",0,o):d<60?n.formatDistance("lessThanXMinutes",1,o):n.formatDistance("xMinutes",1,o):u===0?n.formatDistance("lessThanXMinutes",1,o):n.formatDistance("xMinutes",u,o);if(u<45)return n.formatDistance("xMinutes",u,o);if(u<90)return n.formatDistance("aboutXHours",1,o);if(u<ee){const g=Math.round(u/60);return n.formatDistance("aboutXHours",g,o)}else{if(u<a)return n.formatDistance("xDays",1,o);if(u<B){const g=Math.round(u/ee);return n.formatDistance("xDays",g,o)}else if(u<B*2)return f=Math.round(u/B),n.formatDistance("aboutXMonths",f,o)}if(f=Fe(c,l),f<12){const g=Math.round(u/B);return n.formatDistance("xMonths",g,o)}else{const g=f%12,p=Math.trunc(f/12);return g<3?n.formatDistance("aboutXYears",p,o):g<9?n.formatDistance("overXYears",p,o):n.formatDistance("almostXYears",p+1,o)}}function Rt(r,e){return Ht(r,Te(r),e)}function ie(r){if(!r)return"N/A";const e=["B","KB","MB","GB"];let t=r,s=0;for(;t>=1024&&s<e.length-1;)t/=1024,s++;return`${t.toFixed(2)} ${e[s]}`}function V(r){if(!r)return"Never";try{const e=new Date(r);return Rt(e,{addSuffix:!0})}catch{return"Invalid date"}}function q(r){if(!r)return"N/A";try{const e=new Date(r);return At(e,"MMM d, yyyy HH:mm:ss")}catch{return"Invalid date"}}function oe(r){if(r==null||r<0)return"No expiration";const e=Math.floor(r/3600),t=Math.floor(r%3600/60),s=r%60;return e>0?`${e}h ${t}m ${s}s`:t>0?`${t}m ${s}s`:`${s}s`}function le(r){return`${(r*100).toFixed(1)}%`}function H(r){if(!r)return{text:"Unknown",class:"badge"};const e=r.toLowerCase();return["ft","aot","final","post","completed","finished","match finished"].some(t=>e.includes(t))?{text:"Final",class:"badge info"}:["ns","pre","scheduled","not started"].some(t=>e.includes(t))?{text:"Upcoming",class:"badge warning"}:["live","active","in progress","in play"].some(t=>e.includes(t))||/^\d/.test(e)?{text:"Live",class:"badge success"}:{text:r,class:"badge"}}function w(r,e="success"){const t=document.createElement("div");t.className=`toast ${e}`,t.textContent=r,document.body.appendChild(t),setTimeout(()=>{t.remove()},5e3)}function zt(r){try{const e=JSON.parse(r);return J(e,0)}catch{return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}function J(r,e){const t="  ".repeat(e),s="  ".repeat(e+1);if(r===null)return'<span class="json-null">null</span>';if(typeof r=="boolean")return`<span class="json-boolean">${r}</span>`;if(typeof r=="number")return`<span class="json-number">${r}</span>`;if(typeof r=="string")return`<span class="json-string">"${r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}"</span>`;if(Array.isArray(r)){if(r.length===0)return'<span class="json-punctuation">[]</span>';const n=`collapse-${Math.random().toString(36).substr(2,9)}`,a=r.length===1?"1 item":`${r.length} items`;let i='<span class="json-punctuation">[</span>';return i+=`<span class="json-collapse-btn" data-target="${n}" style="cursor: pointer; color: var(--text-secondary); font-size: 0.75rem; margin-left: 0.5rem;">▼ ${a}</span>`,i+=`
<div id="${n}" class="json-collapsible">`,r.forEach((o,l)=>{i+=s,i+=J(o,e+1),l<r.length-1&&(i+='<span class="json-punctuation">,</span>'),i+=`
...
<div id="${a}" class="json-collapsible">`,n.forEach((l,c)=>{const d=l.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");o+=s,o+=`<span class="json-key">"${d}"</span><span class="json-punctuation">: </span>`,o+=J(r[l],e+1),c<n.length-1&&(o+='<span class="json-punctuation">,</span>'),o+=`
`}),o+=`</div>${t}<span class="json-punctuation">}</span>`,o}return String(r)}class Ot{constructor(){m(this,"logContainer",null);m(this,"logs",[]);m(this,"maxLogs",50);this.createLogContainer()}createLogContainer(){var t,s;const e=document.createElement("div");e.id="connection-log",e.style.cssText=`
      position: fixed;
      bottom: 1rem;
      right: 1rem;
      width: 400px;
    ...
    `,(t=this.container.querySelector("#refresh-live"))==null||t.addEventListener("click",()=>this.manualRefresh()),(s=this.container.querySelector("#toggle-mode"))==null||s.addEventListener("click",()=>this.toggleMode()),this.fetchLiveGames(),this.refreshInterval=setInterval(()=>this.fetchLiveGames(),1e4)}toggleMode(){this.useWebSocket=!this.useWebSocket,this.useWebSocket?(b.log("Switching to WebSocket mode","info"),w("Using WebSocket for live updates","success"),this.refreshInterval&&(clearInterval(this.refreshInterval),this.refreshInterval=null),this.wsManager.connect(e=>this.handleLiveData(e),e=>this.updateConnectionStatus(e))):(b.log("Switching to polling mode","info"),w("Using API polling (10s refresh)","success"),this.wsManager.disconnect(),this.refreshInterval||(this.refreshInterval=setInterval(()=>this.fetchLiveGames(),1e4)),this.fetchLiveGames())}async manualRefresh(){b.log("Manual refresh triggered","info"),w("Refreshing live games...","success"),await this.fetchLiveGames()}async fetchLiveGames(){var t,s;b.log("Fetching live games...","info");const e=Date.now();try{const n=new Promise((d,h)=>setTimeout(()=>h(new Error("Request timed out after 10s")),1e4)),a=fetch("/api/admin/live-espn").then(async d=>{if(!d.ok)throw new Error(`HTTP ${d.status}`);return d.json()}),i=await Promise.race([a,n]),o=Date.now()-e;b.log(`All games fetched in ${o}ms`,"success");const l=(d=[])=>d.filter(h=>{const u=h.strStatus||"";return u==="in"||/^(Q[1-4]|OT|Half|P[1-3])/.test(u)}),c={nba:i.nba?{events:l(i.nba.events)}:void 0,nfl:i.nfl?{events:l(i.nfl.events)}:void 0,nhl:i.nhl?{events:l(i.nhl.events)}:void 0,mlb:i.mlb?{events:l(i.mlb.events)}:void 0,soccer:i.soccer?{events:l(i.soccer.events)}:void 0,golf:i.golf?{events:l(i.golf.events)}:void 0,tennis:i.tennis?{events:l(i.tennis.events)}:void 0,racing:i.racing?{events:l(i.racing.events)}:void 0};this.handleLiveData(c,i)}catch(n){const a=Date.now()-e,i=n instanceof Error?n.message:"Unknown error";b.log(`Failed to fetch live games after ${a}ms: ${i}`,"error");const o=(t=this.container)==null?void 0:t.querySelector("#live-games-content");o&&(o.innerHTML=`
        ...
        `,(s=o.querySelector("#retry-live"))==null||s.addEventListener("click",()=>this.manualRefresh()))}}stop(){this.wsManager.disconnect(),this.updateConnectionStatus(!1),this.refreshInterval&&(clearInterval(this.refreshInterval),this.refreshInterval=null)}updateConnectionStatus(e){var s;this.connectionStatus&&(this.connectionStatus.className=`status-indicator ${e?"connected":"disconnected"}`);const t=(s=this.container)==null?void 0:s.querySelector("#ws-status");t&&(t.className=e?"badge success":"badge warning",t.textContent=e?"Connected":"Disconnected")}handleLiveData(e,t){var l,c;if(!this.container)return;const s=[{name:"NBA",data:e.nba,allData:t==null?void 0:t.nba,color:"#1d428a"},{name:"NFL",data:e.nfl,allData:t==null?void 0:t.nfl,color:"#013369"},{name:"NHL",data:e.nhl,allData:t==null?void 0:t.nhl,color:"#000000"},{name:"MLB",data:e.mlb,allData:t==null?void 0:t.mlb,color:"#002d72"},{name:"Soccer",data:e.soccer,allData:t==null?void 0:t.soccer,color:"#00a650"},{name:"Golf",data:e.golf,allData:t==null?void 0:t.golf,color:"#2ca58d"},{name:"Tennis",data:e.tennis,allData:t==null?void 0:t.tennis,color:"#c8b900"},{name:"Formula 1",data:e.racing,allData:t==null?void 0:t.racing,color:"#e10600"}],n=s.reduce((d,h)=>{var u,f;return d+(((f=(u=h.data)==null?void 0:u.events)==null?void 0:f.length)||0)},0),a=s.reduce((d,h)=>{var u,f;return d+(((f=(u=h.allData)==null?void 0:u.events)==null?void 0:f.length)||0)},0);b.log(`Displaying ${n} live games (${a} total)`,n>0?"success":"info");const i=(l=this.container)==null?void 0:l.querySelector("#live-games-content"),o=(c=this.container)==null?void 0:c.querySelector("#ws-status");if(o&&(o.className=`badge ${n>0?"success":"info"}`,o.textContent=`${n} Live${a>0?` / ${a} Total`:""}`),i){const d=s.filter(u=>{var f,g,p,T;return(((g=(f=u.allData)==null?void 0:f.events)==null?void 0:g.length)||0)>0||(((T=(p=u.data)==null?void 0:p.events)==null?void 0:T.length)||0)>0}).map(u=>{var p,T,P,M;const f=((T=(p=u.data)==null?void 0:p.events)==null?void 0:T.length)||0,g=((M=(P=u.allData)==null?void 0:P.events)==null?void 0:M.length)||0;return`<div style="display: flex; justify-content: space-between; align-items: center; padding: 0.5rem 0; border-bottom: 1px solid var(--border-color);">
            ...
            <div style="display: flex; gap: 0.5rem;">
              ...
              <span class="badge info">${g} Games</span>
            </div>
        ...
        `}
      `,i.querySelectorAll("[data-tournament-id]").forEach(u=>{u.addEventListener("click",f=>{if(f.target.closest("button, a"))return;const g=u.querySelector(".tournament-collapsed"),p=u.querySelector(".tournament-expanded");g&&p&&(g.classList.toggle("hidden"),p.classList.toggle("hidden"))})})}}renderSportSection(e,t,s){return!t||!t.events||t.events.length===0?"":`
      <div class="card">
...
`).filter(h=>h.includes("|")).map((h,u)=>{const f=h.split("|"),g=f[0]||"TBD",p=f[1]||"--",T=f[2]?f[2].split(","):[];return{position:u+1,name:g,score:p,rounds:T}}),a=n.some(h=>h.rounds.length>0),i=Math.max(0,...n.map(h=>h.rounds.length)),o=n.length>0?n.slice(0,5).map(h=>`
        ...
        `).join(""):`<div style="display: flex; justify-content: space-between; align-items: center; padding: 0.25rem 0;">
         ...
         </div>`,l=a?Array.from({length:i},(h,u)=>`<span style="width: 2.5rem; text-align: right; font-size: 0.75rem;">R${u+1}</span>`).join(""):"",c=n.map(h=>{const u=a?Array.from({length:i},(f,g)=>`<span style="width: 2.5rem; text-align: right; font-size: 0.8rem; color: var(--text-secondary);">${h.rounds[g]||"-"}</span>`).join(""):"";return`
    ...
    `}renderLeagueCards(){const e=Array.from(this.leagueStats.entries()).filter(([t,s])=>this.currentFilter==="all"?!0:s.sport===this.currentFilter).sort((t,s)=>t[1].liveGames!==s[1].liveGames?s[1].liveGames-t[1].liveGames:t[1].totalGames!==s[1].totalGames?s[1].totalGames-t[1].totalGames:t[1].league.localeCompare(s[1].league));return e.length===0?`<div style="grid-column: 1 / -1; text-align: center; padding: 3rem; color: var(--text-secondary);">
      ...
      <div class="grid grid-3" style="margin-bottom: 1.5rem;">
        ...
        <div class="stat-card">
          <div class="stat-value" style="color: var(--warning-color);">${g.length}</div>
      ...
      ${g.length>0?`
        <div class="card" style="margin-bottom: 1.5rem;">
          <h3 style="font-size: 1.125rem; font-weight: 600; margin-bottom: 1rem;">
            ${c&&k?`Upcoming Grand Prix (${k.size} GPs, ${g.length} sessions)`:`Upcoming ${l?"Events":"Games"} (${g.length})`}
          </h3>
          ${c&&k?`
            <div>
          ...
          `:`
            <table>
              ...
              <tbody>
                ${g.slice(0,25).map(v=>l?this.renderTournamentRow(v):this.renderGameRow(v)).join("")}
              </tbody>
            </table>
            ${g.length>25?`<div style="text-align: center; margin-top: 1rem; color: var(--text-secondary); font-size: 0.875rem;">Showing 25 of ${g.length} upcoming ${l?"events":"games"}</div>`:""}
          `}
        </div>
      `:""}
...
`).filter(g=>g.includes("|"));if(f.length>0){const g=f[0].split("|");c=g[0]||"",h=g[1]||"",d=g[3]||""}else e.strAwayTeam&&e.strAwayTeam!=="TBD"&&(c=e.strAwayTeam)}const u=a?"rgba(225, 6, 0, 0.04)":"transparent";return`
    ...
    `}updateTeamsGrid(){var t;const e=(t=this.container)==null?void 0:t.querySelector("#teams-grid");e&&(e.innerHTML=this.filteredTeams.map(s=>this.renderTeamCard(s)).join(""))}}class jt{constructor(){m(this,"container",null);m(this,"intervalId",null)}render(e){var t,s,n,a;this.container=e,this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
...
`)}</pre></div>`:""}
        ...
        `),w("Failed to trigger push-to-start","error")}finally{e.disabled=!1,e.textContent=a}}}class _t{constructor(){m(this,"container",null);m(this,"eventSource",null);m(this,"consoleEl",null);m(this,"autoScroll",!0)}render(e){this.container=e,this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
...
`,t==="stderr"&&(s.style.color="#f85149"),this.consoleEl.appendChild(s);this.consoleEl.childNodes.length>5e3;)this.consoleEl.removeChild(this.consoleEl.firstChild);this.autoScroll&&(this.consoleEl.scrollTop=this.consoleEl.scrollHeight)}updateState(e,t,s){const n=document.getElementById("server-badge"),a=document.getElementById("server-pid"),i=document.getElementById("srv-start"),o=document.getElementById("srv-stop"),l=document.getElementById("srv-restart");if(!n)return;const c={stopped:"#6b7280",building:"#f59e0b",running:"#22c55e",error:"#ef4444"};n.textContent=e.toUpperCase(),n.style.background=c[e]??"#6b7280",n.style.color="#fff",a&&(a.textContent=t?`PID ${t}`:""),i&&(i.disabled=e==="running"||e==="building"),o&&(o.disabled=e==="stopped"),l&&(l.disabled=e==="stopped"),s&&this.appendLine(`ERROR: ${s}`,"stderr")}async checkExternalProcess(){try{const t=await(await fetch("/__server/status")).json(),s=document.getElementById("srv-force-kill");if(!s)return;t.state==="stopped"?s.style.display="inline-block":s.style.display="none"}catch{}}}class Yt{constructor(){m(this,"container",null);m(this,"ws",null);m(this,"entries",[]);m(this,"maxEntries",2e3);m(this,"paused",!1);m(this,"autoScroll",!0);m(this,"seenLabels",new Set);m(this,"filter",{level:"debug",labels:[],search:""});m(this,"searchDebounce",null)}render(e){this.container=e,this.entries=[],this.seenLabels=new Set,e.innerHTML=`
    ...
    `;const t=this.container.querySelector("#parity-target");t&&t.addEventListener("change",()=>{this.target=t.value}),(s=this.container.querySelector("#parity-run"))==null||s.addEventListener("click",()=>this.runCheck()),this.renderBody()}stop(){}async runCheck(){if(!this.loading){this.loading=!0,this.renderBody();try{const e=await fetch(`/api/admin/parity?target=${encodeURIComponent(this.target)}`,{headers:{Accept:"application/json"}});if(!e.ok)throw new Error(`HTTP ${e.status} ${e.statusText}`);this.lastResponse=await e.json(),this.lastRunAt=new Date,w(`Parity: ${this.lastResponse.matches} match, ${this.lastResponse.mismatches} mismatch, ${this.lastResponse.errors} error`,this.lastResponse.mismatches+this.lastResponse.errors===0?"success":"error")}catch(e){const t=e instanceof Error?e.message:String(e);w(`Parity check failed: ${t}`,"error"),this.lastResponse=null}finally{this.loading=!1,this.renderBody()}}}renderBody(){var a;const e=(a=this.container)==null?void 0:a.querySelector("#parity-content");if(!e)return;if(this.loading){e.innerHTML='<div class="loading">Comparing…</div>';return}if(!this.lastResponse){e.innerHTML='<div style="color: var(--text-secondary); font-size: 0.875rem;">Click "Run Comparison" to fetch.</div>';return}const t=this.lastResponse,s=`
      <div style="display: flex; gap: 1.5rem; margin-bottom: 1rem; font-size: 0.875rem; color: var(--text-secondary);">
        <div><strong style="color: var(--text-color);">Local:</strong> <code>${j(t.localBase)}</code></div>
        <div><strong style="color: var(--text-color);">Target:</strong> <code>${j(t.targetBase)}</code></div>
    ...
    `,n=t.results.map(i=>{const o=i.match?"✓":i.localStatus===200&&i.targetStatus===200?"≠":"⚠",l=i.match?"#16a34a":i.localStatus===200&&i.targetStatus===200?"#ca8a04":"#dc2626",c=i.diff?`<div style="color: var(--text-secondary); font-size: 0.8rem; margin-top: 0.25rem;">${j(i.diff)}</div>`:"";return`
        <div style="border-bottom: 1px solid var(--border-color); padding: 0.6rem 0;">
          <div style="display: flex; justify-content: space-between; align-items: center; gap: 1rem;">
            <div style="display: flex; gap: 0.5rem; align-items: center; min-width: 0;">
              ...
              <code style="font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${j(i.endpoint)}</code>
            </div>
      ...
      `}).join("");e.innerHTML=s+n}}function j(r){return r.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ce(r){return r<1024?`${r}B`:r<1024*1024?`${(r/1024).toFixed(1)}KB`:`${(r/(1024*1024)).toFixed(1)}MB`}class Kt{constructor(){m(this,"currentView","");m(this,"components",new Map);m(this,"mainContent");this.mainContent=document.getElementById("main-content"),this.components.set("health",new Wt),this.components.set("live",new Gt),this.components.set("leagues",new Nt),this.components.set("gaps",new Bt),this.components.set("redis",new qt),this.components.set("teams",new It),this.components.set("debug",new jt),this.components.set("server",new _t),this.components.set("logs",new Yt),this.components.set("parity",new Ut),this.setupNavigation(),this.showView("health")}setupNavigation(){document.querySelectorAll(".nav-btn").forEach(t=>{t.addEventListener("click",s=>{const n=s.target.dataset.view;n&&this.showView(n)})})}showView(e){if(this.currentView===e)return;document.querySelectorAll(".nav-btn").forEach(n=>{n instanceof HTMLElement&&n.classList.toggle("active",n.dataset.view===e)});const t=this.components.get(this.currentView);t!=null&&t.stop&&t.stop(),this.currentView=e;const s=this.components.get(e);s&&(this.mainContent.innerHTML="",s.render(this.mainContent))}}document.addEventListener("DOMContentLoaded",()=>{new Kt});
