...
`).filter(h=>h.includes("|")).map((h,u)=>{const f=h.split("|"),m=f[0]||"TBD",p=f[1]||"--",T=f[2]?f[2].split(","):[];return{position:u+1,name:m,score:p,rounds:T}}),a=n.some(h=>h.rounds.length>0),i=Math.max(0,...n.map(h=>h.rounds.length)),o=n.length>0?n.slice(0,5).map(h=>`
    ...
    `,(t=this.container.querySelector("#retry-btn"))==null||t.addEventListener("click",()=>{this.showLoadingState(),this.loadData()}))}stop(){}computeAllStats(){if(this.leagueStats.clear(),!this.scheduleData)return;const e=(s,n)=>{const a=new Set,i=this.isIndividualSport(n);let o=0,l=0,c=0;for(const d of s){if(i){if(d.strHomeTeam&&d.strHomeTeam!=="TBD"){const u=n===y.Formula1?this.extractGPName(d.strHomeTeam):d.strHomeTeam;a.add(u)}}else d.strHomeTeam&&a.add(d.strHomeTeam),d.strAwayTeam&&a.add(d.strAwayTeam);const h=(d.strStatus||"").toLowerCase();["ft","aot","final","final/ot","post","completed","finished","match finished","ap"].includes(h)?l++:["ns","pre","","scheduled","not started"].includes(h)?c++:o++}this.leagueStats.set(n,{league:q[n]||"Unknown",leagueId:n,sport:this.getSportForLeague(n),totalGames:s.length,liveGames:o,completedGames:l,upcomingGames:c,teams:Array.from(a).sort()})};this.scheduleData.nba&&e(this.scheduleData.nba.events,y.NBA),this.scheduleData.nfl&&e(this.scheduleData.nfl.events,y.NFL),this.scheduleData.nhl&&e(this.scheduleData.nhl.events,y.NHL),this.scheduleData.mlb&&e(this.scheduleData.mlb.events,y.MLB),this.scheduleData.golf&&e(this.scheduleData.golf.events,y.PGA),this.scheduleData.racing&&e(this.scheduleData.racing.events,y.Formula1);const t=s=>{const n=new Map;for(const a of s){const i=parseInt(a.idLeague||"0");if(!i)continue;const o=n.get(i)||[];o.push(a),n.set(i,o)}return n};if(this.scheduleData.soccer){const s=t(this.scheduleData.soccer.events);for(const[n,a]of s){const i=n;q[i]&&e(a,i)}}if(this.scheduleData.tennis){const s=t(this.scheduleData.tennis.events);for(const[n,a]of s){const i=n;q[i]&&e(a,i)}}b.log(`Computed stats for ${this.leagueStats.size} leagues`,"success")}displayAllLeagues(){var s,n,a;if(!this.container)return;const e=this.leagueStats.size,t=Array.from(this.leagueStats.values()).reduce((i,o)=>i+o.totalGames,0);this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">League Explorer</h2>
          <div style="display: flex; gap: 0.5rem; align-items: center;">
...
`).filter(a=>a.includes("|")).map((a,i)=>{const[o,l]=a.split("|");return{position:i+1,name:o||"TBD",score:l||"--"}}),n=s.length>0?s.map(a=>`
    ...
    `}renderGameRow(e){const t=H(e.strStatus),s=e.intHomeScore||"-",n=e.intAwayScore||"-";return`
      <tr>
        ...
        <td style="font-size: 0.875rem;">${e.strProgress||j(e.strTimestamp)}</td>
      </tr>
...
`).filter(n=>n.includes("|"));return t.length===0?'<div style="padding: 0.5rem; color: var(--text-secondary); font-size: 0.8rem;">No leaderboard data</div>':`
    ...
    `}renderRacingGPGroup(e,t,s){const n=t.find(c=>(c.strHomeTeam||"").toLowerCase().endsWith(" race")),a=t[0],i=a?j(a.strTimestamp):"";let o="",l="";if(s==="completed"&&n){const c=(n.lastPlay||"").split(`
...
`).filter(m=>m.includes("|"));if(f.length>0){const m=f[0].split("|");c=m[0]||"",h=m[1]||"",d=m[3]||""}else e.strAwayTeam&&e.strAwayTeam!=="TBD"&&(c=e.strAwayTeam)}const u=a?"rgba(225, 6, 0, 0.04)":"transparent";return`
      <div ${l?`data-racing-session-id="${e.idEvent}"`:""} style="padding: 0.5rem 1rem; border-bottom: 1px solid var(--border-color); background-color: ${u}; ${l?"cursor: pointer;":""} display: flex; flex-direction: column; transition: background-color 0.15s;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <span style="font-size: 0.8rem; color: var(--text-secondary);">${e.strProgress||j(e.strTimestamp)}</span>
    ...
    `}updateTeamsGrid(){var t;const e=(t=this.container)==null?void 0:t.querySelector("#teams-grid");e&&(e.innerHTML=this.filteredTeams.map(s=>this.renderTeamCard(s)).join(""))}}class It{constructor(){g(this,"container",null);g(this,"intervalId",null)}render(e){var t,s,n,a;this.container=e,this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
...
`)}</pre></div>`:""}
        ...
        `),w("Failed to trigger push-to-start","error")}finally{e.disabled=!1,e.textContent=a}}}class _t{constructor(){g(this,"container",null);g(this,"eventSource",null);g(this,"consoleEl",null);g(this,"autoScroll",!0)}render(e){this.container=e,this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
...
`,t==="stderr"&&(s.style.color="#f85149"),this.consoleEl.appendChild(s);this.consoleEl.childNodes.length>5e3;)this.consoleEl.removeChild(this.consoleEl.firstChild);this.autoScroll&&(this.consoleEl.scrollTop=this.consoleEl.scrollHeight)}updateState(e,t,s){const n=document.getElementById("server-badge"),a=document.getElementById("server-pid"),i=document.getElementById("srv-start"),o=document.getElementById("srv-stop"),l=document.getElementById("srv-restart");if(!n)return;const c={stopped:"#6b7280",building:"#f59e0b",running:"#22c55e",error:"#ef4444"};n.textContent=e.toUpperCase(),n.style.background=c[e]??"#6b7280",n.style.color="#fff",a&&(a.textContent=t?`PID ${t}`:""),i&&(i.disabled=e==="running"||e==="building"),o&&(o.disabled=e==="stopped"),l&&(l.disabled=e==="stopped"),s&&this.appendLine(`ERROR: ${s}`,"stderr")}async checkExternalProcess(){try{const t=await(await fetch("/__server/status")).json(),s=document.getElementById("srv-force-kill");if(!s)return;t.state==="stopped"?s.style.display="inline-block":s.style.display="none"}catch{}}}class Yt{constructor(){g(this,"container",null);g(this,"ws",null);g(this,"entries",[]);g(this,"maxEntries",2e3);g(this,"paused",!1);g(this,"autoScroll",!0);g(this,"seenLabels",new Set);g(this,"filter",{level:"debug",labels:[],search:""});g(this,"searchDebounce",null)}render(e){this.container=e,this.entries=[],this.seenLabels=new Set,e.innerHTML=`
    ...
    `;const t=this.container.querySelector("#parity-target");t&&t.addEventListener("change",()=>{this.target=t.value}),(s=this.container.querySelector("#parity-run"))==null||s.addEventListener("click",()=>this.runCheck()),this.renderBody()}stop(){}async runCheck(){if(!this.loading){this.loading=!0,this.renderBody();try{const e=await fetch(`/api/admin/parity?target=${encodeURIComponent(this.target)}`,{headers:{Accept:"application/json"}});if(!e.ok)throw new Error(`HTTP ${e.status} ${e.statusText}`);this.lastResponse=await e.json(),this.lastRunAt=new Date,w(`Parity: ${this.lastResponse.matches} match, ${this.lastResponse.mismatches} mismatch, ${this.lastResponse.errors} error`,this.lastResponse.mismatches+this.lastResponse.errors===0?"success":"error")}catch(e){const t=e instanceof Error?e.message:String(e);w(`Parity check failed: ${t}`,"error"),this.lastResponse=null}finally{this.loading=!1,this.renderBody()}}}renderBody(){var a;const e=(a=this.container)==null?void 0:a.querySelector("#parity-content");if(!e)return;if(this.loading){e.innerHTML='<div class="loading">Comparing…</div>';return}if(!this.lastResponse){e.innerHTML='<div style="color: var(--text-secondary); font-size: 0.875rem;">Click "Run Comparison" to fetch.</div>';return}const t=this.lastResponse,s=`
      <div style="display: flex; gap: 1.5rem; margin-bottom: 1rem; font-size: 0.875rem; color: var(--text-secondary);">
        <div><strong style="color: var(--text-color);">Local:</strong> <code>${I(t.localBase)}</code></div>
        <div><strong style="color: var(--text-color);">Target:</strong> <code>${I(t.targetBase)}</code></div>
    ...
    `,n=t.results.map(i=>{const o=i.match?"✓":i.localStatus===200&&i.targetStatus===200?"≠":"⚠",l=i.match?"#16a34a":i.localStatus===200&&i.targetStatus===200?"#ca8a04":"#dc2626",c=i.diff?`<div style="color: var(--text-secondary); font-size: 0.8rem; margin-top: 0.25rem;">${I(i.diff)}</div>`:"";return`
        <div style="border-bottom: 1px solid var(--border-color); padding: 0.6rem 0;">
          <div style="display: flex; justify-content: space-between; align-items: center; gap: 1rem;">
            <div style="display: flex; gap: 0.5rem; align-items: center; min-width: 0;">
              ...
              <code style="font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${I(i.endpoint)}</code>
            </div>
      ...
      `}).join("");e.innerHTML=s+n}}function I(r){return r.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ce(r){return r<1024?`${r}B`:r<1024*1024?`${(r/1024).toFixed(1)}KB`:`${(r/(1024*1024)).toFixed(1)}MB`}class Ut{constructor(){g(this,"container",null)}render(e){var t;this.container=e,e.innerHTML=`
      <div class="card">
        <div class="card-header">
