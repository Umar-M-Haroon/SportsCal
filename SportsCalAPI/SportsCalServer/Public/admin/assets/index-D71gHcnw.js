var pe=Object.defineProperty;var ve=(r,e,t)=>e in r?pe(r,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[e]=t;var g=(r,e,t)=>ve(r,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();class ye{constructor(e=""){g(this,"baseUrl");this.baseUrl=e}async fetch(e,t){const s=await fetch(`${this.baseUrl}${e}`,{...t,headers:{"Content-Type":"application/json",...t==null?void 0:t.headers}});if(!s.ok)throw new Error(`API error: ${s.statusText}`);return s.json()}async getHealth(){return this.fetch("/api/admin/health")}async getMetrics(){return this.fetch("/api/admin/metrics")}async getTelemetry(){return this.fetch("/api/admin/telemetry")}async getRedisKeys(){return this.fetch("/api/admin/redis/keys")}async getRedisKey(e){return this.fetch(`/api/admin/redis/key/${encodeURIComponent(e)}`)}async getDataGaps(){return this.fetch("/api/admin/data-gaps")}async getLeagueStats(e){return this.fetch(`/api/admin/leagues/${e}/stats`)}async getSchedules(){return this.fetch("/v2025/schedules")}async getTeams(){return this.fetch("/v2025/teams")}async getLiveGames(){return this.fetch("/v2025/all-live-games")}async invalidateKey(e){return this.fetch(`/api/admin/redis/invalidate/${encodeURIComponent(e)}`,{method:"POST"})}async refreshSchedules(){return this.fetch("/api/admin/redis/refresh",{method:"POST"})}async forceRefresh(){return this.fetch("/api/admin/force-refresh",{method:"POST"})}async triggerJob(e){return this.fetch(`/api/admin/jobs/trigger/${e}`,{method:"POST"})}async clearAllCache(){return this.fetch("/api/admin/cache/all",{method:"DELETE"})}async getPushToStartRegistrations(){return this.fetch("/api/admin/push-to-start/registrations")}async getPushToStartDiagnostics(){return this.fetch("/api/admin/push-to-start/diagnostics")}async triggerDebugPushToStart(e,t,s){return this.fetch("/v2025/debug/trigger-push-to-start",{method:"POST",body:JSON.stringify({eventID:e,homeTeam:t,awayTeam:s})})}}const C=new ye;class be{constructor(e="ws://localhost:8080/ws"){g(this,"ws",null);g(this,"reconnectTimer",null);g(this,"reconnectDelay",5e3);g(this,"url");g(this,"onMessageCallback",null);g(this,"onStatusChange",null);this.url=e}connect(e,t){var s;this.onMessageCallback=e,this.onStatusChange=t||null;try{const n=window.location.protocol==="https:"?this.url.replace("ws://","wss://"):this.url;this.ws=new WebSocket(n),this.ws.onopen=()=>{var a;console.log("WebSocket connected"),(a=this.onStatusChange)==null||a.call(this,!0),this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null)},this.ws.onmessage=a=>{var i;try{const o=JSON.parse(a.data);(i=this.onMessageCallback)==null||i.call(this,o)}catch(o){console.error("Failed to parse WebSocket message:",o)}},this.ws.onerror=a=>{var i;console.error("WebSocket error:",a),(i=this.onStatusChange)==null||i.call(this,!1)},this.ws.onclose=()=>{var a;console.log("WebSocket disconnected"),(a=this.onStatusChange)==null||a.call(this,!1),this.scheduleReconnect()}}catch(n){console.error("Failed to connect WebSocket:",n),(s=this.onStatusChange)==null||s.call(this,!1),this.scheduleReconnect()}}scheduleReconnect(){this.reconnectTimer||(this.reconnectTimer=setTimeout(()=>{console.log("Attempting to reconnect WebSocket..."),this.onMessageCallback&&this.connect(this.onMessageCallback,this.onStatusChange||void 0)},this.reconnectDelay))}disconnect(){this.reconnectTimer&&(clearTimeout(this.reconnectTimer),this.reconnectTimer=null),this.ws&&(this.ws.close(),this.ws=null)}isConnected(){var e;return((e=this.ws)==null?void 0:e.readyState)===WebSocket.OPEN}}function x(r){const e=Object.prototype.toString.call(r);return r instanceof Date||typeof r=="object"&&e==="[object Date]"?new r.constructor(+r):typeof r=="number"||e==="[object Number]"||typeof r=="string"||e==="[object String]"?new Date(r):new Date(NaN)}function A(r,e){return r instanceof Date?new r.constructor(e):new Date(e)}const de=6048e5,we=864e5,N=43200,ee=1440;let $e={};function _(){return $e}function W(r,e){var o,l,c,d;const t=_(),s=(e==null?void 0:e.weekStartsOn)??((l=(o=e==null?void 0:e.locale)==null?void 0:o.options)==null?void 0:l.weekStartsOn)??t.weekStartsOn??((d=(c=t.locale)==null?void 0:c.options)==null?void 0:d.weekStartsOn)??0,n=x(r),a=n.getDay(),i=(a<s?7:0)+a-s;return n.setDate(n.getDate()-i),n.setHours(0,0,0,0),n}function Y(r){return W(r,{weekStartsOn:1})}function ue(r){const e=x(r),t=e.getFullYear(),s=A(r,0);s.setFullYear(t+1,0,4),s.setHours(0,0,0,0);const n=Y(s),a=A(r,0);a.setFullYear(t,0,4),a.setHours(0,0,0,0);const i=Y(a);return e.getTime()>=n.getTime()?t+1:e.getTime()>=i.getTime()?t:t-1}function te(r){const e=x(r);return e.setHours(0,0,0,0),e}function K(r){const e=x(r),t=new Date(Date.UTC(e.getFullYear(),e.getMonth(),e.getDate(),e.getHours(),e.getMinutes(),e.getSeconds(),e.getMilliseconds()));return t.setUTCFullYear(e.getFullYear()),+r-+t}function xe(r,e){const t=te(r),s=te(e),n=+t-K(t),a=+s-K(s);return Math.round((n-a)/we)}function Se(r){const e=ue(r),t=A(r,0);return t.setFullYear(e,0,4),t.setHours(0,0,0,0),Y(t)}function I(r,e){const t=x(r),s=x(e),n=t.getTime()-s.getTime();return n<0?-1:n>0?1:n}function Te(r){return A(r,Date.now())}function Le(r){return r instanceof Date||typeof r=="object"&&Object.prototype.toString.call(r)==="[object Date]"}function ke(r){if(!Le(r)&&typeof r!="number")return!1;const e=x(r);return!isNaN(Number(e))}function Ee(r,e){const t=x(r),s=x(e),n=t.getFullYear()-s.getFullYear(),a=t.getMonth()-s.getMonth();return n*12+a}function Ce(r){return e=>{const s=(r?Math[r]:Math.trunc)(e);return s===0?0:s}}function Me(r,e){return+x(r)-+x(e)}function Pe(r){const e=x(r);return e.setHours(23,59,59,999),e}function De(r){const e=x(r),t=e.getMonth();return e.setFullYear(e.getFullYear(),t+1,0),e.setHours(23,59,59,999),e}function Ae(r){const e=x(r);return+Pe(e)==+De(e)}function Fe(r,e){const t=x(r),s=x(e),n=I(t,s),a=Math.abs(Ee(t,s));let i;if(a<1)i=0;else{t.getMonth()===1&&t.getDate()>27&&t.setDate(30),t.setMonth(t.getMonth()-n*a);let o=I(t,s)===-n;Ae(x(r))&&a===1&&I(r,s)===1&&(o=!1),i=n*(a-Number(o))}return i===0?0:i}function He(r,e,t){const s=Me(r,e)/1e3;return Ce(t==null?void 0:t.roundingMethod)(s)}function Re(r){const e=x(r),t=A(r,0);return t.setFullYear(e.getFullYear(),0,1),t.setHours(0,0,0,0),t}const ze={lessThanXSeconds:{one:"less than a second",other:"less than {{count}} seconds"},xSeconds:{one:"1 second",other:"{{count}} seconds"},halfAMinute:"half a minute",lessThanXMinutes:{one:"less than a minute",other:"less than {{count}} minutes"},xMinutes:{one:"1 minute",other:"{{count}} minutes"},aboutXHours:{one:"about 1 hour",other:"about {{count}} hours"},xHours:{one:"1 hour",other:"{{count}} hours"},xDays:{one:"1 day",other:"{{count}} days"},aboutXWeeks:{one:"about 1 week",other:"about {{count}} weeks"},xWeeks:{one:"1 week",other:"{{count}} weeks"},aboutXMonths:{one:"about 1 month",other:"about {{count}} months"},xMonths:{one:"1 month",other:"{{count}} months"},aboutXYears:{one:"about 1 year",other:"about {{count}} years"},xYears:{one:"1 year",other:"{{count}} years"},overXYears:{one:"over 1 year",other:"over {{count}} years"},almostXYears:{one:"almost 1 year",other:"almost {{count}} years"}},Oe=(r,e,t)=>{let s;const n=ze[r];return typeof n=="string"?s=n:e===1?s=n.one:s=n.other.replace("{{count}}",e.toString()),t!=null&&t.addSuffix?t.comparison&&t.comparison>0?"in "+s:s+" ago":s};function X(r){return(e={})=>{const t=e.width?String(e.width):r.defaultWidth;return r.formats[t]||r.formats[r.defaultWidth]}}const Ge={full:"EEEE, MMMM do, y",long:"MMMM do, y",medium:"MMM d, y",short:"MM/dd/yyyy"},We={full:"h:mm:ss a zzzz",long:"h:mm:ss a z",medium:"h:mm:ss a",short:"h:mm a"},_e={full:"{{date}} 'at' {{time}}",long:"{{date}} 'at' {{time}}",medium:"{{date}}, {{time}}",short:"{{date}}, {{time}}"},Ne={date:X({formats:Ge,defaultWidth:"full"}),time:X({formats:We,defaultWidth:"full"}),dateTime:X({formats:_e,defaultWidth:"full"})},Be={lastWeek:"'last' eeee 'at' p",yesterday:"'yesterday at' p",today:"'today at' p",tomorrow:"'tomorrow at' p",nextWeek:"eeee 'at' p",other:"P"},je=(r,e,t,s)=>Be[r];function O(r){return(e,t)=>{const s=t!=null&&t.context?String(t.context):"standalone";let n;if(s==="formatting"&&r.formattingValues){const i=r.defaultFormattingWidth||r.defaultWidth,o=t!=null&&t.width?String(t.width):i;n=r.formattingValues[o]||r.formattingValues[i]}else{const i=r.defaultWidth,o=t!=null&&t.width?String(t.width):r.defaultWidth;n=r.values[o]||r.values[i]}const a=r.argumentCallback?r.argumentCallback(e):e;return n[a]}}const qe={narrow:["B","A"],abbreviated:["BC","AD"],wide:["Before Christ","Anno Domini"]},Ie={narrow:["1","2","3","4"],abbreviated:["Q1","Q2","Q3","Q4"],wide:["1st quarter","2nd quarter","3rd quarter","4th quarter"]},Ye={narrow:["J","F","M","A","M","J","J","A","S","O","N","D"],abbreviated:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],wide:["January","February","March","April","May","June","July","August","September","October","November","December"]},Ke={narrow:["S","M","T","W","T","F","S"],short:["Su","Mo","Tu","We","Th","Fr","Sa"],abbreviated:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],wide:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"]},Ue={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"}},Xe={narrow:{am:"a",pm:"p",midnight:"mi",noon:"n",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},abbreviated:{am:"AM",pm:"PM",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"},wide:{am:"a.m.",pm:"p.m.",midnight:"midnight",noon:"noon",morning:"in the morning",afternoon:"in the afternoon",evening:"in the evening",night:"at night"}},Je=(r,e)=>{const t=Number(r),s=t%100;if(s>20||s<10)switch(s%10){case 1:return t+"st";case 2:return t+"nd";case 3:return t+"rd"}return t+"th"},Ve={ordinalNumber:Je,era:O({values:qe,defaultWidth:"wide"}),quarter:O({values:Ie,defaultWidth:"wide",argumentCallback:r=>r-1}),month:O({values:Ye,defaultWidth:"wide"}),day:O({values:Ke,defaultWidth:"wide"}),dayPeriod:O({values:Ue,defaultWidth:"wide",formattingValues:Xe,defaultFormattingWidth:"wide"})};function G(r){return(e,t={})=>{const s=t.width,n=s&&r.matchPatterns[s]||r.matchPatterns[r.defaultMatchWidth],a=e.match(n);if(!a)return null;const i=a[0],o=s&&r.parsePatterns[s]||r.parsePatterns[r.defaultParseWidth],l=Array.isArray(o)?Ze(o,h=>h.test(i)):Qe(o,h=>h.test(i));let c;c=r.valueCallback?r.valueCallback(l):l,c=t.valueCallback?t.valueCallback(c):c;const d=e.slice(i.length);return{value:c,rest:d}}}function Qe(r,e){for(const t in r)if(Object.prototype.hasOwnProperty.call(r,t)&&e(r[t]))return t}function Ze(r,e){for(let t=0;t<r.length;t++)if(e(r[t]))return t}function et(r){return(e,t={})=>{const s=e.match(r.matchPattern);if(!s)return null;const n=s[0],a=e.match(r.parsePattern);if(!a)return null;let i=r.valueCallback?r.valueCallback(a[0]):a[0];i=t.valueCallback?t.valueCallback(i):i;const o=e.slice(n.length);return{value:i,rest:o}}}const tt=/^(\d+)(th|st|nd|rd)?/i,st=/\d+/i,rt={narrow:/^(b|a)/i,abbreviated:/^(b\.?\s?c\.?|b\.?\s?c\.?\s?e\.?|a\.?\s?d\.?|c\.?\s?e\.?)/i,wide:/^(before christ|before common era|anno domini|common era)/i},nt={any:[/^b/i,/^(a|c)/i]},at={narrow:/^[1234]/i,abbreviated:/^q[1234]/i,wide:/^[1234](th|st|nd|rd)? quarter/i},it={any:[/1/i,/2/i,/3/i,/4/i]},ot={narrow:/^[jfmasond]/i,abbreviated:/^(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec)/i,wide:/^(january|february|march|april|may|june|july|august|september|october|november|december)/i},lt={narrow:[/^j/i,/^f/i,/^m/i,/^a/i,/^m/i,/^j/i,/^j/i,/^a/i,/^s/i,/^o/i,/^n/i,/^d/i],any:[/^ja/i,/^f/i,/^mar/i,/^ap/i,/^may/i,/^jun/i,/^jul/i,/^au/i,/^s/i,/^o/i,/^n/i,/^d/i]},ct={narrow:/^[smtwf]/i,short:/^(su|mo|tu|we|th|fr|sa)/i,abbreviated:/^(sun|mon|tue|wed|thu|fri|sat)/i,wide:/^(sunday|monday|tuesday|wednesday|thursday|friday|saturday)/i},dt={narrow:[/^s/i,/^m/i,/^t/i,/^w/i,/^t/i,/^f/i,/^s/i],any:[/^su/i,/^m/i,/^tu/i,/^w/i,/^th/i,/^f/i,/^sa/i]},ut={narrow:/^(a|p|mi|n|(in the|at) (morning|afternoon|evening|night))/i,any:/^([ap]\.?\s?m\.?|midnight|noon|(in the|at) (morning|afternoon|evening|night))/i},ht={any:{am:/^a/i,pm:/^p/i,midnight:/^mi/i,noon:/^no/i,morning:/morning/i,afternoon:/afternoon/i,evening:/evening/i,night:/night/i}},mt={ordinalNumber:et({matchPattern:tt,parsePattern:st,valueCallback:r=>parseInt(r,10)}),era:G({matchPatterns:rt,defaultMatchWidth:"wide",parsePatterns:nt,defaultParseWidth:"any"}),quarter:G({matchPatterns:at,defaultMatchWidth:"wide",parsePatterns:it,defaultParseWidth:"any",valueCallback:r=>r+1}),month:G({matchPatterns:ot,defaultMatchWidth:"wide",parsePatterns:lt,defaultParseWidth:"any"}),day:G({matchPatterns:ct,defaultMatchWidth:"wide",parsePatterns:dt,defaultParseWidth:"any"}),dayPeriod:G({matchPatterns:ut,defaultMatchWidth:"any",parsePatterns:ht,defaultParseWidth:"any"})},he={code:"en-US",formatDistance:Oe,formatLong:Ne,formatRelative:je,localize:Ve,match:mt,options:{weekStartsOn:0,firstWeekContainsDate:1}};function gt(r){const e=x(r);return xe(e,Re(e))+1}function ft(r){const e=x(r),t=+Y(e)-+Se(e);return Math.round(t/de)+1}function me(r,e){var d,h,u,f;const t=x(r),s=t.getFullYear(),n=_(),a=(e==null?void 0:e.firstWeekContainsDate)??((h=(d=e==null?void 0:e.locale)==null?void 0:d.options)==null?void 0:h.firstWeekContainsDate)??n.firstWeekContainsDate??((f=(u=n.locale)==null?void 0:u.options)==null?void 0:f.firstWeekContainsDate)??1,i=A(r,0);i.setFullYear(s+1,0,a),i.setHours(0,0,0,0);const o=W(i,e),l=A(r,0);l.setFullYear(s,0,a),l.setHours(0,0,0,0);const c=W(l,e);return t.getTime()>=o.getTime()?s+1:t.getTime()>=c.getTime()?s:s-1}function pt(r,e){var o,l,c,d;const t=_(),s=(e==null?void 0:e.firstWeekContainsDate)??((l=(o=e==null?void 0:e.locale)==null?void 0:o.options)==null?void 0:l.firstWeekContainsDate)??t.firstWeekContainsDate??((d=(c=t.locale)==null?void 0:c.options)==null?void 0:d.firstWeekContainsDate)??1,n=me(r,e),a=A(r,0);return a.setFullYear(n,0,s),a.setHours(0,0,0,0),W(a,e)}function vt(r,e){const t=x(r),s=+W(t,e)-+pt(t,e);return Math.round(s/de)+1}function $(r,e){const t=r<0?"-":"",s=Math.abs(r).toString().padStart(e,"0");return t+s}const D={y(r,e){const t=r.getFullYear(),s=t>0?t:1-t;return $(e==="yy"?s%100:s,e.length)},M(r,e){const t=r.getMonth();return e==="M"?String(t+1):$(t+1,2)},d(r,e){return $(r.getDate(),e.length)},a(r,e){const t=r.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return t.toUpperCase();case"aaa":return t;case"aaaaa":return t[0];case"aaaa":default:return t==="am"?"a.m.":"p.m."}},h(r,e){return $(r.getHours()%12||12,e.length)},H(r,e){return $(r.getHours(),e.length)},m(r,e){return $(r.getMinutes(),e.length)},s(r,e){return $(r.getSeconds(),e.length)},S(r,e){const t=e.length,s=r.getMilliseconds(),n=Math.trunc(s*Math.pow(10,t-3));return $(n,e.length)}},R={midnight:"midnight",noon:"noon",morning:"morning",afternoon:"afternoon",evening:"evening",night:"night"},se={G:function(r,e,t){const s=r.getFullYear()>0?1:0;switch(e){case"G":case"GG":case"GGG":return t.era(s,{width:"abbreviated"});case"GGGGG":return t.era(s,{width:"narrow"});case"GGGG":default:return t.era(s,{width:"wide"})}},y:function(r,e,t){if(e==="yo"){const s=r.getFullYear(),n=s>0?s:1-s;return t.ordinalNumber(n,{unit:"year"})}return D.y(r,e)},Y:function(r,e,t,s){const n=me(r,s),a=n>0?n:1-n;if(e==="YY"){const i=a%100;return $(i,2)}return e==="Yo"?t.ordinalNumber(a,{unit:"year"}):$(a,e.length)},R:function(r,e){const t=ue(r);return $(t,e.length)},u:function(r,e){const t=r.getFullYear();return $(t,e.length)},Q:function(r,e,t){const s=Math.ceil((r.getMonth()+1)/3);switch(e){case"Q":return String(s);case"QQ":return $(s,2);case"Qo":return t.ordinalNumber(s,{unit:"quarter"});case"QQQ":return t.quarter(s,{width:"abbreviated",context:"formatting"});case"QQQQQ":return t.quarter(s,{width:"narrow",context:"formatting"});case"QQQQ":default:return t.quarter(s,{width:"wide",context:"formatting"})}},q:function(r,e,t){const s=Math.ceil((r.getMonth()+1)/3);switch(e){case"q":return String(s);case"qq":return $(s,2);case"qo":return t.ordinalNumber(s,{unit:"quarter"});case"qqq":return t.quarter(s,{width:"abbreviated",context:"standalone"});case"qqqqq":return t.quarter(s,{width:"narrow",context:"standalone"});case"qqqq":default:return t.quarter(s,{width:"wide",context:"standalone"})}},M:function(r,e,t){const s=r.getMonth();switch(e){case"M":case"MM":return D.M(r,e);case"Mo":return t.ordinalNumber(s+1,{unit:"month"});case"MMM":return t.month(s,{width:"abbreviated",context:"formatting"});case"MMMMM":return t.month(s,{width:"narrow",context:"formatting"});case"MMMM":default:return t.month(s,{width:"wide",context:"formatting"})}},L:function(r,e,t){const s=r.getMonth();switch(e){case"L":return String(s+1);case"LL":return $(s+1,2);case"Lo":return t.ordinalNumber(s+1,{unit:"month"});case"LLL":return t.month(s,{width:"abbreviated",context:"standalone"});case"LLLLL":return t.month(s,{width:"narrow",context:"standalone"});case"LLLL":default:return t.month(s,{width:"wide",context:"standalone"})}},w:function(r,e,t,s){const n=vt(r,s);return e==="wo"?t.ordinalNumber(n,{unit:"week"}):$(n,e.length)},I:function(r,e,t){const s=ft(r);return e==="Io"?t.ordinalNumber(s,{unit:"week"}):$(s,e.length)},d:function(r,e,t){return e==="do"?t.ordinalNumber(r.getDate(),{unit:"date"}):D.d(r,e)},D:function(r,e,t){const s=gt(r);return e==="Do"?t.ordinalNumber(s,{unit:"dayOfYear"}):$(s,e.length)},E:function(r,e,t){const s=r.getDay();switch(e){case"E":case"EE":case"EEE":return t.day(s,{width:"abbreviated",context:"formatting"});case"EEEEE":return t.day(s,{width:"narrow",context:"formatting"});case"EEEEEE":return t.day(s,{width:"short",context:"formatting"});case"EEEE":default:return t.day(s,{width:"wide",context:"formatting"})}},e:function(r,e,t,s){const n=r.getDay(),a=(n-s.weekStartsOn+8)%7||7;switch(e){case"e":return String(a);case"ee":return $(a,2);case"eo":return t.ordinalNumber(a,{unit:"day"});case"eee":return t.day(n,{width:"abbreviated",context:"formatting"});case"eeeee":return t.day(n,{width:"narrow",context:"formatting"});case"eeeeee":return t.day(n,{width:"short",context:"formatting"});case"eeee":default:return t.day(n,{width:"wide",context:"formatting"})}},c:function(r,e,t,s){const n=r.getDay(),a=(n-s.weekStartsOn+8)%7||7;switch(e){case"c":return String(a);case"cc":return $(a,e.length);case"co":return t.ordinalNumber(a,{unit:"day"});case"ccc":return t.day(n,{width:"abbreviated",context:"standalone"});case"ccccc":return t.day(n,{width:"narrow",context:"standalone"});case"cccccc":return t.day(n,{width:"short",context:"standalone"});case"cccc":default:return t.day(n,{width:"wide",context:"standalone"})}},i:function(r,e,t){const s=r.getDay(),n=s===0?7:s;switch(e){case"i":return String(n);case"ii":return $(n,e.length);case"io":return t.ordinalNumber(n,{unit:"day"});case"iii":return t.day(s,{width:"abbreviated",context:"formatting"});case"iiiii":return t.day(s,{width:"narrow",context:"formatting"});case"iiiiii":return t.day(s,{width:"short",context:"formatting"});case"iiii":default:return t.day(s,{width:"wide",context:"formatting"})}},a:function(r,e,t){const n=r.getHours()/12>=1?"pm":"am";switch(e){case"a":case"aa":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"aaa":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"aaaaa":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"aaaa":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},b:function(r,e,t){const s=r.getHours();let n;switch(s===12?n=R.noon:s===0?n=R.midnight:n=s/12>=1?"pm":"am",e){case"b":case"bb":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"bbb":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"}).toLowerCase();case"bbbbb":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"bbbb":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},B:function(r,e,t){const s=r.getHours();let n;switch(s>=17?n=R.evening:s>=12?n=R.afternoon:s>=4?n=R.morning:n=R.night,e){case"B":case"BB":case"BBB":return t.dayPeriod(n,{width:"abbreviated",context:"formatting"});case"BBBBB":return t.dayPeriod(n,{width:"narrow",context:"formatting"});case"BBBB":default:return t.dayPeriod(n,{width:"wide",context:"formatting"})}},h:function(r,e,t){if(e==="ho"){let s=r.getHours()%12;return s===0&&(s=12),t.ordinalNumber(s,{unit:"hour"})}return D.h(r,e)},H:function(r,e,t){return e==="Ho"?t.ordinalNumber(r.getHours(),{unit:"hour"}):D.H(r,e)},K:function(r,e,t){const s=r.getHours()%12;return e==="Ko"?t.ordinalNumber(s,{unit:"hour"}):$(s,e.length)},k:function(r,e,t){let s=r.getHours();return s===0&&(s=24),e==="ko"?t.ordinalNumber(s,{unit:"hour"}):$(s,e.length)},m:function(r,e,t){return e==="mo"?t.ordinalNumber(r.getMinutes(),{unit:"minute"}):D.m(r,e)},s:function(r,e,t){return e==="so"?t.ordinalNumber(r.getSeconds(),{unit:"second"}):D.s(r,e)},S:function(r,e){return D.S(r,e)},X:function(r,e,t){const s=r.getTimezoneOffset();if(s===0)return"Z";switch(e){case"X":return ne(s);case"XXXX":case"XX":return F(s);case"XXXXX":case"XXX":default:return F(s,":")}},x:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"x":return ne(s);case"xxxx":case"xx":return F(s);case"xxxxx":case"xxx":default:return F(s,":")}},O:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"O":case"OO":case"OOO":return"GMT"+re(s,":");case"OOOO":default:return"GMT"+F(s,":")}},z:function(r,e,t){const s=r.getTimezoneOffset();switch(e){case"z":case"zz":case"zzz":return"GMT"+re(s,":");case"zzzz":default:return"GMT"+F(s,":")}},t:function(r,e,t){const s=Math.trunc(r.getTime()/1e3);return $(s,e.length)},T:function(r,e,t){const s=r.getTime();return $(s,e.length)}};function re(r,e=""){const t=r>0?"-":"+",s=Math.abs(r),n=Math.trunc(s/60),a=s%60;return a===0?t+String(n):t+String(n)+e+$(a,2)}function ne(r,e){return r%60===0?(r>0?"-":"+")+$(Math.abs(r)/60,2):F(r,e)}function F(r,e=""){const t=r>0?"-":"+",s=Math.abs(r),n=$(Math.trunc(s/60),2),a=$(s%60,2);return t+n+e+a}const ae=(r,e)=>{switch(r){case"P":return e.date({width:"short"});case"PP":return e.date({width:"medium"});case"PPP":return e.date({width:"long"});case"PPPP":default:return e.date({width:"full"})}},ge=(r,e)=>{switch(r){case"p":return e.time({width:"short"});case"pp":return e.time({width:"medium"});case"ppp":return e.time({width:"long"});case"pppp":default:return e.time({width:"full"})}},yt=(r,e)=>{const t=r.match(/(P+)(p+)?/)||[],s=t[1],n=t[2];if(!n)return ae(r,e);let a;switch(s){case"P":a=e.dateTime({width:"short"});break;case"PP":a=e.dateTime({width:"medium"});break;case"PPP":a=e.dateTime({width:"long"});break;case"PPPP":default:a=e.dateTime({width:"full"});break}return a.replace("{{date}}",ae(s,e)).replace("{{time}}",ge(n,e))},bt={p:ge,P:yt},wt=/^D+$/,$t=/^Y+$/,xt=["D","DD","YY","YYYY"];function St(r){return wt.test(r)}function Tt(r){return $t.test(r)}function Lt(r,e,t){const s=kt(r,e,t);if(console.warn(s),xt.includes(r))throw new RangeError(s)}function kt(r,e,t){const s=r[0]==="Y"?"years":"days of the month";return`Use \`${r.toLowerCase()}\` instead of \`${r}\` (in \`${e}\`) for formatting ${s} to the input \`${t}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`}const Et=/[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,Ct=/P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,Mt=/^'([^]*?)'?$/,Pt=/''/g,Dt=/[a-zA-Z]/;function At(r,e,t){var d,h,u,f;const s=_(),n=s.locale??he,a=s.firstWeekContainsDate??((h=(d=s.locale)==null?void 0:d.options)==null?void 0:h.firstWeekContainsDate)??1,i=s.weekStartsOn??((f=(u=s.locale)==null?void 0:u.options)==null?void 0:f.weekStartsOn)??0,o=x(r);if(!ke(o))throw new RangeError("Invalid time value");let l=e.match(Ct).map(m=>{const p=m[0];if(p==="p"||p==="P"){const T=bt[p];return T(m,n.formatLong)}return m}).join("").match(Et).map(m=>{if(m==="''")return{isToken:!1,value:"'"};const p=m[0];if(p==="'")return{isToken:!1,value:Ft(m)};if(se[p])return{isToken:!0,value:m};if(p.match(Dt))throw new RangeError("Format string contains an unescaped latin alphabet character `"+p+"`");return{isToken:!1,value:m}});n.localize.preprocessor&&(l=n.localize.preprocessor(o,l));const c={firstWeekContainsDate:a,weekStartsOn:i,locale:n};return l.map(m=>{if(!m.isToken)return m.value;const p=m.value;(Tt(p)||St(p))&&Lt(p,e,String(r));const T=se[p[0]];return T(o,p,n.localize,c)}).join("")}function Ft(r){const e=r.match(Mt);return e?e[1].replace(Pt,"'"):r}function Ht(r,e,t){const s=_(),n=(t==null?void 0:t.locale)??s.locale??he,a=2520,i=I(r,e);if(isNaN(i))throw new RangeError("Invalid time value");const o=Object.assign({},t,{addSuffix:t==null?void 0:t.addSuffix,comparison:i});let l,c;i>0?(l=x(e),c=x(r)):(l=x(r),c=x(e));const d=He(c,l),h=(K(c)-K(l))/1e3,u=Math.round((d-h)/60);let f;if(u<2)return t!=null&&t.includeSeconds?d<5?n.formatDistance("lessThanXSeconds",5,o):d<10?n.formatDistance("lessThanXSeconds",10,o):d<20?n.formatDistance("lessThanXSeconds",20,o):d<40?n.formatDistance("halfAMinute",0,o):d<60?n.formatDistance("lessThanXMinutes",1,o):n.formatDistance("xMinutes",1,o):u===0?n.formatDistance("lessThanXMinutes",1,o):n.formatDistance("xMinutes",u,o);if(u<45)return n.formatDistance("xMinutes",u,o);if(u<90)return n.formatDistance("aboutXHours",1,o);if(u<ee){const m=Math.round(u/60);return n.formatDistance("aboutXHours",m,o)}else{if(u<a)return n.formatDistance("xDays",1,o);if(u<N){const m=Math.round(u/ee);return n.formatDistance("xDays",m,o)}else if(u<N*2)return f=Math.round(u/N),n.formatDistance("aboutXMonths",f,o)}if(f=Fe(c,l),f<12){const m=Math.round(u/N);return n.formatDistance("xMonths",m,o)}else{const m=f%12,p=Math.trunc(f/12);return m<3?n.formatDistance("aboutXYears",p,o):m<9?n.formatDistance("overXYears",p,o):n.formatDistance("almostXYears",p+1,o)}}function Rt(r,e){return Ht(r,Te(r),e)}function ie(r){if(!r)return"N/A";const e=["B","KB","MB","GB"];let t=r,s=0;for(;t>=1024&&s<e.length-1;)t/=1024,s++;return`${t.toFixed(2)} ${e[s]}`}function J(r){if(!r)return"Never";try{const e=new Date(r);return Rt(e,{addSuffix:!0})}catch{return"Invalid date"}}function B(r){if(!r)return"N/A";try{const e=new Date(r);return At(e,"MMM d, yyyy HH:mm:ss")}catch{return"Invalid date"}}function oe(r){if(r==null||r<0)return"No expiration";const e=Math.floor(r/3600),t=Math.floor(r%3600/60),s=r%60;return e>0?`${e}h ${t}m ${s}s`:t>0?`${t}m ${s}s`:`${s}s`}function le(r){return`${(r*100).toFixed(1)}%`}function H(r){if(!r)return{text:"Unknown",class:"badge"};const e=r.toLowerCase();return["ft","aot","final","post","completed","finished","match finished"].some(t=>e.includes(t))?{text:"Final",class:"badge info"}:["ns","pre","scheduled","not started"].some(t=>e.includes(t))?{text:"Upcoming",class:"badge warning"}:["live","active","in progress","in play"].some(t=>e.includes(t))||/^\d/.test(e)?{text:"Live",class:"badge success"}:{text:r,class:"badge"}}function w(r,e="success"){const t=document.createElement("div");t.className=`toast ${e}`,t.textContent=r,document.body.appendChild(t),setTimeout(()=>{t.remove()},5e3)}function zt(r){try{const e=JSON.parse(r);return V(e,0)}catch{return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}}function V(r,e){const t="  ".repeat(e),s="  ".repeat(e+1);if(r===null)return'<span class="json-null">null</span>';if(typeof r=="boolean")return`<span class="json-boolean">${r}</span>`;if(typeof r=="number")return`<span class="json-number">${r}</span>`;if(typeof r=="string")return`<span class="json-string">"${r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}"</span>`;if(Array.isArray(r)){if(r.length===0)return'<span class="json-punctuation">[]</span>';const n=`collapse-${Math.random().toString(36).substr(2,9)}`,a=r.length===1?"1 item":`${r.length} items`;let i='<span class="json-punctuation">[</span>';return i+=`<span class="json-collapse-btn" data-target="${n}" style="cursor: pointer; color: var(--text-secondary); font-size: 0.75rem; margin-left: 0.5rem;">▼ ${a}</span>`,i+=`
...
`}),o+=`</div>${t}<span class="json-punctuation">}</span>`,o}return String(r)}class Ot{constructor(){g(this,"logContainer",null);g(this,"logs",[]);g(this,"maxLogs",50);this.createLogContainer()}createLogContainer(){var t,s;const e=document.createElement("div");e.id="connection-log",e.style.cssText=`
      position: fixed;
      bottom: 1rem;
      right: 1rem;
      width: 400px;
    ...
    `;const t=this.container.querySelector("#refresh-health");t==null||t.addEventListener("click",()=>this.manualRefresh()),b.log("Health Monitor initialized","info"),this.fetchHealthWithTimeout(),this.intervalId=setInterval(()=>this.fetchHealthWithTimeout(),1e4)}manualRefresh(){b.log("Manual refresh triggered","info"),w("Refreshing health status...","success"),this.fetchHealthWithTimeout()}stop(){this.intervalId&&(clearInterval(this.intervalId),this.intervalId=null)}async fetchHealthWithTimeout(){var t,s;const e=Date.now();b.log("Fetching health status from /api/admin/health...","info");try{const n=new Promise((l,c)=>setTimeout(()=>c(new Error("Request timeout after 5s")),5e3)),a=C.getHealth(),i=await Promise.race([a,n]),o=Date.now()-e;b.log(`Health status received in ${o}ms`,"success"),this.lastFetchTime=new Date,this.displayHealth(i)}catch(n){const a=Date.now()-e,i=n instanceof Error?n.message:"Unknown error";b.log(`Health fetch failed after ${a}ms: ${i}`,"error"),console.error("Failed to fetch health:",n);const o=(t=this.container)==null?void 0:t.querySelector("#health-content");o&&(o.innerHTML=`
        ...
        `,(s=o.querySelector("#retry-health"))==null||s.addEventListener("click",()=>this.manualRefresh())),w("Failed to fetch health status","error")}}displayHealth(e){var l;const t=(l=this.container)==null?void 0:l.querySelector("#health-content");if(!t)return;const s=e.status==="healthy",n=this.lastFetchTime?J(this.lastFetchTime.toISOString()):"just now";t.innerHTML=`
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">System Health</h2>
      ...
      <div style="display: flex; justify-content: space-between; align-items: center; padding: 1rem; background: var(--bg-color); border-radius: 0.375rem; font-size: 0.875rem; color: var(--text-secondary);">
        ...
        <span>Server time: ${J(e.timestamp)}</span>
      </div>
    `;const a=t.querySelector("#force-refresh");a==null||a.addEventListener("click",()=>this.forceRefresh(a));const i=t.querySelector("#refresh-schedules");i==null||i.addEventListener("click",()=>this.refreshSchedules());const o=t.querySelector("#clear-cache");o==null||o.addEventListener("click",()=>this.clearCache()),t.querySelectorAll(".trigger-job-btn").forEach(c=>{c.addEventListener("click",d=>{const h=d.target.dataset.job;h&&this.triggerJob(h,d.target)})})}async forceRefresh(e){const t=e.textContent;e.disabled=!0,e.textContent="Refreshing...";try{const s=await C.forceRefresh(),n=Object.entries(s.gamesLoaded).filter(([,a])=>a>0).map(([a,i])=>`${a}: ${i}`).join(", ");w(`${s.message}${n?` (${n})`:""}`,"success"),this.fetchHealthWithTimeout()}catch{w("Failed to force refresh schedules","error")}finally{e.disabled=!1,e.textContent=t}}async refreshSchedules(){try{const e=await C.refreshSchedules();w(e.message,"success"),this.fetchHealthWithTimeout()}catch{w("Failed to refresh schedules","error")}}async triggerJob(e,t){const s=t.textContent;t.disabled=!0,t.textContent="Running...";try{const n=await C.triggerJob(e);w(n.message,n.success?"success":"error"),this.fetchHealthWithTimeout()}catch{w(`Failed to trigger ${e}`,"error")}finally{t.disabled=!1,t.textContent=s}}async clearCache(){if(confirm("Are you sure you want to clear ALL cache? This will delete all Redis keys."))try{const e=await C.clearAllCache();w(e.message,"success"),this.fetchHealthWithTimeout()}catch{w("Failed to clear cache","error")}}}class Wt{constructor(){g(this,"container",null);g(this,"wsManager");g(this,"connectionStatus",null);g(this,"useWebSocket",!0);g(this,"refreshInterval",null);this.wsManager=new be,this.connectionStatus=document.getElementById("connection-status")}render(e){var t,s;this.container=e,b.log("Live Games initialized","info"),this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
    ...
    `}renderGame(e,t){return t==="Golf"||t==="Tennis"||t==="Formula 1"?this.renderTournamentGame(e):this.renderTeamGame(e)}renderTeamGame(e){const t=H(e.strStatus),s=e.intHomeScore||"0",n=e.intAwayScore||"0";return`
      <div style="border: 1px solid var(--border-color); border-radius: 0.375rem; padding: 1rem;">
        ...
        ${e.aggregateScore||e.legDisplay?`
        <div style="margin-top: 0.5rem; font-size: 0.75rem; color: var(--text-secondary);">
          ${[e.legDisplay,e.aggregateScore].filter(Boolean).join(" · ")}
        </div>`:""}
      </div>
...
`).filter(h=>h.includes("|")).map((h,u)=>{const f=h.split("|"),m=f[0]||"TBD",p=f[1]||"--",T=f[2]?f[2].split(","):[];return{position:u+1,name:m,score:p,rounds:T}}),a=n.some(h=>h.rounds.length>0),i=Math.max(0,...n.map(h=>h.rounds.length)),o=n.length>0?n.slice(0,5).map(h=>`
    ...
    `}renderLeagueCards(){const e=Array.from(this.leagueStats.entries()).filter(([t,s])=>this.currentFilter==="all"?!0:s.sport===this.currentFilter).sort((t,s)=>t[1].liveGames!==s[1].liveGames?s[1].liveGames-t[1].liveGames:t[1].totalGames!==s[1].totalGames?s[1].totalGames-t[1].totalGames:t[1].league.localeCompare(s[1].league));return e.length===0?`<div style="grid-column: 1 / -1; text-align: center; padding: 3rem; color: var(--text-secondary);">
      ...
      <div style="border-left: 4px solid ${P}; padding-left: 1rem; margin-bottom: 1.5rem;">
        ...
        <div style="color: var(--text-secondary); font-size: 0.875rem;">${this.capitalizeFirst(T)} &middot; ${a.length} total ${fe} &middot; ${t.teams.length} ${Q}</div>
      </div>
      ...
      <div style="margin-bottom: 1.5rem;">
        ...
        ${o.length>1&&o.length<=40?`
          <div>
            ...
            <div style="display: flex; gap: 0.5rem; flex-wrap: wrap;">
              <button class="filter-btn ${this.selectedTeam==="all"?"active":""}" data-team="all">All ${Q}</button>
              ${o.map(v=>`
...
`).filter(a=>a.includes("|")).map((a,i)=>{const[o,l]=a.split("|");return{position:i+1,name:o||"TBD",score:l||"--"}}),n=s.length>0?s.map(a=>`
    ...
    `}renderGameRow(e){const t=H(e.strStatus),s=e.intHomeScore||"-",n=e.intAwayScore||"-";return`
      <tr>
        ...
        <td style="font-size: 0.875rem;">${e.strProgress||B(e.strTimestamp)}</td>
      </tr>
...
`).filter(n=>n.includes("|"));return t.length===0?'<div style="padding: 0.5rem; color: var(--text-secondary); font-size: 0.8rem;">No leaderboard data</div>':`
    ...
    `}renderRacingGPGroup(e,t,s){const n=t.find(c=>(c.strHomeTeam||"").toLowerCase().endsWith(" race")),a=t[0],i=a?B(a.strTimestamp):"";let o="",l="";if(s==="completed"&&n){const c=(n.lastPlay||"").split(`
...
`).filter(m=>m.includes("|"));if(f.length>0){const m=f[0].split("|");c=m[0]||"",h=m[1]||"",d=m[3]||""}else e.strAwayTeam&&e.strAwayTeam!=="TBD"&&(c=e.strAwayTeam)}const u=a?"rgba(225, 6, 0, 0.04)":"transparent";return`
      <div ${l?`data-racing-session-id="${e.idEvent}"`:""} style="padding: 0.5rem 1rem; border-bottom: 1px solid var(--border-color); background-color: ${u}; ${l?"cursor: pointer;":""} display: flex; flex-direction: column; transition: background-color 0.15s;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <div style="display: flex; align-items: center; gap: 0.5rem;">
            <span style="font-size: 0.8rem; color: var(--text-secondary);">${e.strProgress||B(e.strTimestamp)}</span>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <span class="badge ${e.summary.overallCompleteness>.95?"success":e.summary.overallCompleteness>.8?"warning":"danger"}">
            ${le(e.summary.overallCompleteness)} Complete
          </span>
        </div>
    ...
    `)}renderLeagueRow(e){const t=e.completeness,s=t>.95?"success":t>.8?"warning":"danger";return`
      <tr>
        ...
        <td><span class="badge ${s}">${le(t)}</span></td>
      </tr>
    ...
    `,t.style.display="block";try{const o=Date.now(),l=await C.getRedisKey(e),c=Date.now()-o;b.log(`Key content loaded (${l.value.length} bytes) in ${c}ms`,"success");const d=zt(l.value);t.innerHTML=`
        <div class="card">
          <div class="card-header">
            <h3 class="card-title" style="font-family: monospace; font-size: 1rem; word-break: break-all;">${this.escapeHtml(e)}</h3>
            <div style="display: flex; gap: 0.5rem;">
              <span class="badge info">${l.type}</span>
              ${l.ttl?`<span class="badge warning">TTL: ${oe(l.ttl)}</span>`:""}
              <span class="badge info">${ie(l.value.length)}</span>
            </div>
          </div>
      ...
      `,(n=t.querySelector("#copy-json"))==null||n.addEventListener("click",()=>{navigator.clipboard.writeText(l.value),w("Copied to clipboard","success")}),(a=t.querySelector("#close-detail"))==null||a.addEventListener("click",()=>{t&&(t.style.display="none")}),this.setupJSONCollapseHandlers(t),t.scrollIntoView({behavior:"smooth",block:"nearest"})}catch(o){b.log(`Failed to fetch key content: ${o}`,"error"),console.error("Failed to fetch key content:",o),w("Failed to fetch key content","error"),t.innerHTML=`
        <div class="card">
          <div style="text-align: center; padding: 3rem; color: var(--danger-color);">
            <div style="font-size: 3rem; margin-bottom: 1rem;">⚠️</div>
...
`)}</pre></div>`:""}
        ...
        `}w(`Push-to-start sent to ${S.notified} device(s)`,S.notified>0?"success":"error")}catch(S){const k=S instanceof Error?S.message:"Unknown error";i&&(i.innerHTML=`
          <div style="padding: 1rem; border-radius: 0.375rem; background: rgba(239,68,68,0.1); color: var(--danger-color);">
        ...
        `),w("Failed to trigger push-to-start","error")}finally{e.disabled=!1,e.textContent=a}}}class It{constructor(){g(this,"container",null);g(this,"eventSource",null);g(this,"consoleEl",null);g(this,"autoScroll",!0)}render(e){this.container=e,this.container.innerHTML=`
      <div class="card">
        <div class="card-header">
...
`,t==="stderr"&&(s.style.color="#f85149"),this.consoleEl.appendChild(s);this.consoleEl.childNodes.length>5e3;)this.consoleEl.removeChild(this.consoleEl.firstChild);this.autoScroll&&(this.consoleEl.scrollTop=this.consoleEl.scrollHeight)}updateState(e,t,s){const n=document.getElementById("server-badge"),a=document.getElementById("server-pid"),i=document.getElementById("srv-start"),o=document.getElementById("srv-stop"),l=document.getElementById("srv-restart");if(!n)return;const c={stopped:"#6b7280",building:"#f59e0b",running:"#22c55e",error:"#ef4444"};n.textContent=e.toUpperCase(),n.style.background=c[e]??"#6b7280",n.style.color="#fff",a&&(a.textContent=t?`PID ${t}`:""),i&&(i.disabled=e==="running"||e==="building"),o&&(o.disabled=e==="stopped"),l&&(l.disabled=e==="stopped");const d=document.getElementById("srv-open-admin");if(d){const h=e==="running";d.style.pointerEvents=h?"auto":"none",d.style.opacity=h?"1":"0.5"}s&&this.appendLine(`ERROR: ${s}`,"stderr")}async checkExternalProcess(){try{const t=await(await fetch("/__server/status")).json(),s=document.getElementById("srv-force-kill");if(!s)return;t.state==="stopped"?s.style.display="inline-block":s.style.display="none"}catch{}}}class Yt{constructor(){g(this,"container",null);g(this,"ws",null);g(this,"entries",[]);g(this,"maxEntries",2e3);g(this,"paused",!1);g(this,"autoScroll",!0);g(this,"seenLabels",new Set);g(this,"filter",{level:"debug",labels:[],search:""});g(this,"searchDebounce",null)}render(e){this.container=e,this.entries=[],this.seenLabels=new Set,e.innerHTML=`
    ...
    `;const t=this.container.querySelector("#parity-target");t&&t.addEventListener("change",()=>{this.target=t.value}),(s=this.container.querySelector("#parity-run"))==null||s.addEventListener("click",()=>this.runCheck()),this.renderBody()}stop(){}async runCheck(){if(!this.loading){this.loading=!0,this.renderBody();try{const e=await fetch(`/api/admin/parity?target=${encodeURIComponent(this.target)}`,{headers:{Accept:"application/json"}});if(!e.ok)throw new Error(`HTTP ${e.status} ${e.statusText}`);this.lastResponse=await e.json(),this.lastRunAt=new Date,w(`Parity: ${this.lastResponse.matches} match, ${this.lastResponse.mismatches} mismatch, ${this.lastResponse.errors} error`,this.lastResponse.mismatches+this.lastResponse.errors===0?"success":"error")}catch(e){const t=e instanceof Error?e.message:String(e);w(`Parity check failed: ${t}`,"error"),this.lastResponse=null}finally{this.loading=!1,this.renderBody()}}}renderBody(){var a;const e=(a=this.container)==null?void 0:a.querySelector("#parity-content");if(!e)return;if(this.loading){e.innerHTML='<div class="loading">Comparing…</div>';return}if(!this.lastResponse){e.innerHTML='<div style="color: var(--text-secondary); font-size: 0.875rem;">Click "Run Comparison" to fetch.</div>';return}const t=this.lastResponse,s=`
      <div style="display: flex; gap: 1.5rem; margin-bottom: 1rem; font-size: 0.875rem; color: var(--text-secondary);">
        <div><strong style="color: var(--text-color);">Local:</strong> <code>${q(t.localBase)}</code></div>
        <div><strong style="color: var(--text-color);">Target:</strong> <code>${q(t.targetBase)}</code></div>
        ${this.lastRunAt?`<div>ran at ${this.lastRunAt.toLocaleTimeString()}</div>`:""}
      </div>
      <div style="display: flex; gap: 0.75rem; margin-bottom: 1rem;">
        <span class="badge" style="background: rgba(34,197,94,0.15); color: #16a34a; padding: 0.25rem 0.6rem; border-radius: 999px; font-weight: 600; font-size: 0.85rem;">${t.matches} match</span>
        <span class="badge" style="background: rgba(234,179,8,0.15); color: #ca8a04; padding: 0.25rem 0.6rem; border-radius: 999px; font-weight: 600; font-size: 0.85rem;">${t.mismatches} mismatch</span>
        <span class="badge" style="background: rgba(239,68,68,0.15); color: #dc2626; padding: 0.25rem 0.6rem; border-radius: 999px; font-weight: 600; font-size: 0.85rem;">${t.errors} error</span>
      </div>
    `,n=t.results.map(i=>{const o=i.match?"✓":i.localStatus===200&&i.targetStatus===200?"≠":"⚠",l=i.match?"#16a34a":i.localStatus===200&&i.targetStatus===200?"#ca8a04":"#dc2626",c=i.diff?`<div style="color: var(--text-secondary); font-size: 0.8rem; margin-top: 0.25rem;">${q(i.diff)}</div>`:"";return`
        <div style="border-bottom: 1px solid var(--border-color); padding: 0.6rem 0;">
          <div style="display: flex; justify-content: space-between; align-items: center; gap: 1rem;">
            <div style="display: flex; gap: 0.5rem; align-items: center; min-width: 0;">
              <span style="color: ${l}; font-weight: 700; font-size: 1.05rem;">${o}</span>
              <code style="font-size: 0.85rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${q(i.endpoint)}</code>
            </div>
            <div style="color: var(--text-secondary); font-size: 0.8rem; white-space: nowrap;">
              ${i.localStatus}/${i.targetStatus} · ${ce(i.localBytes)}/${ce(i.targetBytes)}
            </div>
          </div>
          ${c}
        </div>
      `}).join("");e.innerHTML=s+n}}function q(r){return r.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ce(r){return r<1024?`${r}B`:r<1024*1024?`${(r/1024).toFixed(1)}KB`:`${(r/(1024*1024)).toFixed(1)}MB`}class Ut{constructor(){g(this,"container",null)}render(e){var t;this.container=e,e.innerHTML=`
      <div class="card">
        <div class="card-header">
    ...
    `,(t=e.querySelector("#wc-refresh"))==null||t.addEventListener("click",()=>this.load()),this.load()}stop(){}async load(){var c,d,h;const e=(c=this.container)==null?void 0:c.querySelector("#wc-content");if(!e)return;e.innerHTML="Loading…";const[t,s,n]=await Promise.all([this.fetchJSON("/v2025/standings/4429"),this.fetchJSON("/v2025/worldcup/bracket"),this.fetchJSON("/v2025/worldcup/scorers")]),a=((h=(d=t==null?void 0:t.standings)==null?void 0:d.children)==null?void 0:h.filter(u=>{var f,m;return(((m=(f=u.standings)==null?void 0:f.entries)==null?void 0:m.length)??0)>0}))??[],i=(s==null?void 0:s.rounds)??[],o=i.reduce((u,f)=>{var m;return u+(((m=f.matches)==null?void 0:m.length)??0)},0),l=n??[];e.innerHTML=`
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1rem; margin-bottom: 1rem;">
        ${this.stat("Groups",`${a.length}`,a.length===12?"ok":a.length>0?"warn":"bad")}
        ${this.stat("Bracket rounds",`${i.length}`,i.length>0?"ok":"warn")}
        ${this.stat("Knockout matches",`${o}`,o>0?"ok":"warn")}
        ${this.stat("Third place",s!=null&&s.thirdPlacePlayoff?"yes":"no",s!=null&&s.thirdPlacePlayoff?"ok":"warn")}
        ${this.stat("Top scorers",`${l.length}`,l.length>0?"ok":"warn")}
      </div>
      ${this.groupsTable(a)}
      ${this.roundsTable(i)}
      ${this.scorersTable(l)}
    `}async fetchJSON(e){try{const t=await fetch(e,{headers:{"Content-Type":"application/json"}});return t.ok?await t.json():null}catch{return null}}stat(e,t,s){return`
      <div style="border: 1px solid var(--border-color); border-radius: 0.5rem; padding: 0.75rem;">
        <div style="font-size: 0.75rem; color: var(--text-secondary); text-transform: uppercase;">${e}</div>
        <div style="font-size: 1.5rem; font-weight: 700; color: ${s==="ok"?"var(--success-color, #1f8b3f)":s==="warn"?"var(--warning-color, #b8860b)":"var(--error-color, #d63b2f)"};">${t}</div>
      </div>
    `}groupsTable(e){return e.length===0?"":`<h3 style="margin-top:1rem;">Groups</h3><ul style="color: var(--text-secondary);">${e.map(s=>{var n,a;return`<li>${s.name??"Group"} — ${((a=(n=s.standings)==null?void 0:n.entries)==null?void 0:a.length)??0} teams</li>`}).join("")}</ul>`}roundsTable(e){return e.length===0?"":`<h3 style="margin-top:1rem;">Bracket</h3><ul style="color: var(--text-secondary);">${e.map(s=>{var n;return`<li>${s.roundName} — ${((n=s.matches)==null?void 0:n.length)??0} matches</li>`}).join("")}</ul>`}scorersTable(e){return e.length===0?"":`<h3 style="margin-top:1rem;">Golden Boot</h3><ol style="color: var(--text-secondary);">${e.slice(0,10).map(s=>`<li>${s.rank}. ${s.playerName} (${s.teamName}) — ${s.goals}</li>`).join("")}</ol>`}}const Xt=["gate_hit","paywall_shown","paywall_dismissed","purchase_completed","trial_started","activation_first_favorite","activation_notifications_enabled","ad_upsell_tapped","rating_prompt_shown"];class Jt{constructor(){g(this,"container",null);g(this,"days",14)}render(e){var s;this.container=e,e.innerHTML=`
      <div class="card">
        <div class="card-header">
    ...
    `;const t=e.querySelector("#funnel-range");t.addEventListener("change",()=>{this.days=parseInt(t.value,10)||14,this.load()}),(s=e.querySelector("#funnel-refresh"))==null||s.addEventListener("click",()=>this.load()),this.load()}async load(){var t;const e=(t=this.container)==null?void 0:t.querySelector("#funnel-body");if(e){e.innerHTML="Loading…";try{const{counters:s}=await C.getTelemetry();e.innerHTML=this.renderBody(this.sum(s))}catch(s){e.innerHTML=`<div class="badge danger">Failed to load telemetry: ${s instanceof Error?s.message:String(s)}</div>`}}}sum(e){const t=Math.floor(Date.now()/864e5),s={};for(const n of Xt){const a=e[`client.${n}`]||{};let i=0;for(let o=t-this.days+1;o<=t;o++)i+=a[String(o)]||0;s[n]=i}return s}pct(e,t){return t<=0?"—":`${(e/t*100).toFixed(1)}%`}renderBody(e){const t=e.purchase_completed+e.trial_started,s=[{label:"Pro gate hit",value:e.gate_hit,note:"user blocked by a Pro feature"},{label:"Paywall shown",value:e.paywall_shown,note:this.pct(e.paywall_shown,e.gate_hit)+" of gate hits"},{label:"Purchase or trial",value:t,note:this.pct(t,e.paywall_shown)+" of paywalls"}],n=Math.max(1,...s.map(o=>o.value)),a=s.map(o=>{const l=Math.max(2,Math.round(o.value/n*100));return`
          <div style="margin-bottom:0.85rem;">
            <div style="display:flex; justify-content:space-between; font-size:0.85rem; margin-bottom:0.25rem;">
              <span><strong>${o.label}</strong></span>
              <span style="color:var(--text-secondary);">${o.value.toLocaleString()} · ${o.note}</span>
            </div>
            <div style="background:var(--bg-secondary, #1e1e1e); border-radius:6px; overflow:hidden;">
              <div style="width:${l}%; background:var(--accent, #3b82f6); height:22px; border-radius:6px;"></div>
            </div>
          </div>`}).join(""),i=(o,l,c="")=>`
      <div class="stat-card">
        <div class="stat-value">${l.toLocaleString()}</div>
        <div class="stat-label">${o}${c?` <span style="color:var(--text-secondary)">(${c})</span>`:""}</div>
      </div>`;return`
      <div style="max-width:680px; margin-bottom:1.5rem;">${a}</div>

      <h3 style="margin:0.5rem 0 0.75rem; font-size:0.95rem;">Conversion</h3>
      <div class="stats-grid" style="margin-bottom:1.5rem;">
        ${i("Gate → Paywall",e.paywall_shown,this.pct(e.paywall_shown,e.gate_hit))}
        ${i("Paywall → Buy/Trial",e.purchase_completed+e.trial_started,this.pct(e.purchase_completed+e.trial_started,e.paywall_shown))}
        ${i("Purchases",e.purchase_completed)}
        ${i("Trials started",e.trial_started)}
        ${i("Paywall dismissed",e.paywall_dismissed,this.pct(e.paywall_dismissed,e.paywall_shown))}
        ${i("Ad “remove ads” taps",e.ad_upsell_tapped)}
      </div>

      <h3 style="margin:0.5rem 0 0.75rem; font-size:0.95rem;">Activation & engagement</h3>
      <div class="stats-grid">
        ${i("First favorite added",e.activation_first_favorite)}
        ${i("Notifications enabled",e.activation_notifications_enabled)}
        ${i("Rating prompts shown",e.rating_prompt_shown)}
      </div>
    `}}class Vt{constructor(){g(this,"currentView","");g(this,"components",new Map);g(this,"mainContent");this.mainContent=document.getElementById("main-content"),this.components.set("health",new Gt),this.components.set("live",new Wt),this.components.set("leagues",new _t),this.components.set("gaps",new Nt),this.components.set("redis",new Bt),this.components.set("teams",new jt),this.components.set("debug",new qt),this.components.set("server",new It),this.components.set("logs",new Yt),this.components.set("parity",new Kt),this.components.set("worldcup",new Ut),this.components.set("funnel",new Jt),this.setupNavigation(),this.showView("health")}setupNavigation(){document.querySelectorAll(".nav-btn").forEach(t=>{t.addEventListener("click",s=>{const n=s.target.dataset.view;n&&this.showView(n)})})}showView(e){if(this.currentView===e)return;document.querySelectorAll(".nav-btn").forEach(n=>{n instanceof HTMLElement&&n.classList.toggle("active",n.dataset.view===e)});const t=this.components.get(this.currentView);t!=null&&t.stop&&t.stop(),this.currentView=e;const s=this.components.get(e);s&&(this.mainContent.innerHTML="",s.render(this.mainContent))}}document.addEventListener("DOMContentLoaded",()=>{new Vt});
